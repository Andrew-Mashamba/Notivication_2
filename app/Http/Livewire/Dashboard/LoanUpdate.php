                   ...
                   if(round($payment,2)>= round($installment,2)){
                       ...
                       if($date > Carbon::today()){
                           ...
                           if($daysDif==1){
                               ...
                               return '<div class=" p-2 rounded-lg text-align-center item-center bg-blue-500"> '.$date->format('Y-m-d').' - Day After Tomorrow </div>';

                           }else{
                               return '<div class=" p-2 rounded-lg text-align-center item-center bg-blue-500"> '.$date->format('Y-m-d').'  </div>';
