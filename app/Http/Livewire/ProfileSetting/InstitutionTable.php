...
class InstitutionTable extends LivewireDatatable
{
        ...
        return [
            ...
            Column::callback('loan_id',function($id){
                 return '<div class="flex items-center space-x-4 flex-lg-row">
                             ...
                             <svg xmlns="http://www.w3.org/2000/svg" wire:click="view('.$id.')"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#DD0035" class="w-6 h-6 cursor-pointer">
    ...
    public function approveInstitution($id){
        ...
        User::create([
            ...
            'role'=>DB::table('roles')->where('department_name','MANAGEMENT')->value('id'),
            'branch'=>$branch_id,
            'institution_id'=>$id,
        ...
        User::create([
            ...
            'password'=>Hash::make('1234567890'),
            'role'=>DB::table('roles')->where('department_name','DEVELOPERS')->value('id'),
            'branch'=>$branch_id,
            'institution_id'=>$id,
            'remember_token' => Str::random(10),
        ]);
