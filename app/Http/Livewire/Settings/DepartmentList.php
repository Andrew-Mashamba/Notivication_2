    ...
    public function columns(): array
    {
        return [
            ...
            Column::callback(['permissions'], function ($permissions) {
                return view('livewire.settings.role-list-action', ['permissions' => $permissions, 'move' => false]);
            ...
            Column::callback(['id'], function ($id) {
                return view('livewire.settings.role-list-action-delete', ['id' => $id, 'move' => false]);
