        ...
        return [
            ...
            Column::callback(['id','institution_id','branch_status'], function ($id,$member_number,$status) use ($html) {
                ...
                $html = '<div class="w-full">
                            <button wire:click="viewloan('.$id.','.$member_number.','.$status.')" class=" m-2 py-2 px-4 text-sm font-medium text-center yellow
                            ...
                            dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
