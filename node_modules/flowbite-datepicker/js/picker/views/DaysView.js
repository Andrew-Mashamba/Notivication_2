...
export default class DaysView extends View {
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      el.className = `datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center yellow dark:text-white font-semibold text-sm ${this.cellClass}`;
      ...
      if (this.selected.includes(current)) {
        ...
        classList.remove('yellow', 'text-gray-500', 'hover:bg-gray-100', 'dark:text-white', 'dark:hover:bg-gray-600', 'dark:bg-gray-600', 'bg-gray-100', 'bg-gray-200');
      }
  ...
  refresh() {
    ...
    this.grid
      ...
      .forEach((el) => {
        ...
        el.classList.add('yellow', 'rounded-lg', 'dark:text-white');
      });
    Array.from(this.grid.children).forEach((el) => {
      ...
      if (this.selected.includes(current)) {
        classList.add('selected', 'bg-blue-700', '!bg-primary-700', 'text-white', 'dark:bg-blue-600', 'dark:!bg-primary-600', 'dark:text-white');
        classList.remove('yellow', 'hover:bg-gray-100', 'dark:text-white', 'dark:hover:bg-gray-600', 'bg-gray-100', 'bg-gray-200', 'dark:bg-gray-600');
      }
      if (current === this.focused) {
        classList.add('focused');
      }
