...
.group:hover .group-hover\:yellow {
  --tw-text-opacity: 1;
  color: rgb(17 24 39 / var(--tw-text-opacity));
}
...
.group:focus .group-focus\:yellow {
  --tw-text-opacity: 1;
  color: rgb(17 24 39 / var(--tw-text-opacity));
}
...
:is(.dark .dark\:placeholder-blue-500)::-moz-placeholder {
  --tw-placeholder-opacity: 1;
  color: rgb(14 159 110 / var(--tw-placeholder-opacity));
}

:is(.dark .dark\:placeholder-blue-500)::placeholder {
  --tw-placeholder-opacity: 1;
  color: rgb(14 159 110 / var(--tw-placeholder-opacity));
}
...
:is(.dark .dark\:hover\:yellow:hover) {
  --tw-text-opacity: 1;
  color: rgb(17 24 39 / var(--tw-text-opacity));
}
