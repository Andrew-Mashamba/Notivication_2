            ...
            <table class="table-auto w-full">
                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left font-medium text-blue-500">$2,890.66</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left font-medium text-blue-500">$2,767.04</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-lg text-center">🇩🇪</div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left font-medium text-blue-500">$1,220.66</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-lg text-center">🇫🇷</div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left font-medium text-blue-500">$1,890.66</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-lg text-center">🇬🇧</div>
                        </td>
