                ...
                <div>
                    ...
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-400 dark:text-blue-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#DD0035" viewBox="0 0 20 20">
                        ...
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-400 dark:text-gray-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#DD0035" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                            </svg>
            ...
            py-2 px-4 rounded-lg"
                    ...
                    >
                        ...
                        <div wire:loading wire:target="menuItemClicked({{ $menuItem['id'] }})">
                            <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:yellow fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#DD0035"/>
                ...
                <div class="w-full bg-white  p-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">AccountsAccount Name</p>
                            ...
                            <p for="membershipNumber" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Membership Number</p>
                            ...
                            <p for="parentAccountsAccount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Parent AccountsAccount</p>
                            <select wire:model.bounce="parentAccountsAccount" name="parentAccountsAccount" id="parentAccountsAccount" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                    ...
                    <div class="flex items-stretch">
                        ...
                        <div class="w-1/2 mr-2" >
                            ...
                            <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Select Member</p>
                            ...
                            @if($this->member)
                                ...
                                <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Saving Account</p>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <div wire:loading wire:target="setAccount({{$account->account_number}})" >
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="animate-spin  h-9 w-9 stroke-gray-400 rounded-full p-2" fill="white" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            ...
                            @if($this->product)
                                <div class="flex justify-between">
                                    <p class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Price per share</p>
                                ...
                                <div class="flex justify-between">
                                    <p class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Available accounts for this user</p>
                                    @php
                                ...
                                @if($this->number_of_accounts)
                                    <div class="flex justify-between">
                                        <p class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Total price</p>
                                ...
                                <p for="linked_accounts_account" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Purchase from linked Accounts Account</p>
                                <select wire:model.bounce="linked_accounts_account" name="linked_accounts_account" id="linked_accounts_account" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option tab_id value="">Select</option>
                                ...
                                @if($this->linked_accounts_account)
                                    <div class="flex justify-between">
                                        <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Account balance</p>
