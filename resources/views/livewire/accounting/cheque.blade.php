                ...
                <li class="mr-2" wire:click="setView(1)">
                    ...
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 1) aria-current="page" @endif>
                        ...
                        dark:text-gray-500 dark:group-hover:text-gray-300 @endif " fill="#DD0035"
                    ...
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 2) aria-current="page" @endif >
                        ...
                        dark:text-gray-500 dark:group-hover:text-gray-300 @endif "
                             fill="#DD0035" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="p-4">
                        ...
                        <select wire:model.bounce="selected_bank" name="selected_bank" id="selected_bank" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <input id="cheque_number" name="cheque_number" type="text" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.bounce="cheque_number" autofocus >
                        </input>
                        @error('cheque_number')
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="p-4">
                        ...
                        <select wire:model="account_id" name="account_id" id="account_id" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected unselected >Select ....</option>
                        ...
                        <input id="leave_number" name="leave_number" type="number" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model="leave_number" autofocus >
