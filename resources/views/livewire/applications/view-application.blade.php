                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div class="bg-gray-100 p-4 rounded-3xl">
                                    <h3 class="text-lg font-semibold mb-2">Progress Stage</h3>
...
{{--                                            {{$this->application->application_status}}--}}
{{--                                        </p>--}}
                                        <h3 class="text-sm font-semibold mb-2 mt-4">
                                            {{\Illuminate\Support\Facades\DB::table('processes')->where('id',$this->application->process)->value('process_name')}}
                                        </h3>
                                        <h3 class="text-xs text-orange-500 font-semibold mb-6 mt-2">
                                            {{\Illuminate\Support\Facades\DB::table('steps')->where('step_number',$this->application->step)->where('process_id',$this->application->process)->value('step_name')}}
                                        </h3>
                                    </div>
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                ...
                                <div class="w-full flex gap-2">
                                    ...
                                    <p class="text-gray-600 text-sm font-bold tracking-tight text-gray-900 leading-tight my-auto">
                                        {{$this->application->approval_status}}
                                    </p>
                                </div>
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                ...
                                <h3 class="text-lg font-semibold mb-2">Actions</h3>
                                    ...
                                    <div class="grid grid-cols-3 grid-rows-2 gap-0">
                                        <button wire:click="review" class="rounded-tl-3xl w-full h-16 bg-blue-600 text-white border border-gray-300">For Review</button>
                                        <button wire:click="approve" class="w-full h-16 bg-blue-600 text-white border border-gray-300">Approve</button>
                                        <button wire:click="reject" class="rounded-tr-3xl w-full h-16 bg-blue-600 text-white border border-gray-300">Reject</button>
                                        <button wire:click="return" class="rounded-bl-3xl w-full h-16 bg-blue-600 text-white border border-gray-300">Return</button>
                                        <button wire:click="archive" class="w-full h-16 bg-blue-600 text-white border border-gray-300">Archive</button>
                                        <button wire:click="disburse" class="rounded-br-3xl w-full h-16 bg-blue-600 text-white border border-gray-300">Disbursed</button>
                                    </div>
                        ...
                        <div class="flex w-full gap-4">
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl w-1/2 max-h-60">
                                ...
                                <div class="w-full lg:w-6/12 px-4">
                                    ...
                                    transition-all duration-150">
                                            {{\Illuminate\Support\Facades\DB::table('farmers')->where('id',$this->application->client_id)->value('first_name')}}
                                            {{\Illuminate\Support\Facades\DB::table('farmers')->where('id',$this->application->client_id)->value('last_name')}}
                                ...
                                <div class="w-full lg:w-6/12 px-4">
                                    ...
                                    transition-all duration-150">
                                            {{number_format($this->application->loan_amount,2)}} TZS
                                        </h3>
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl w-1/2 max-h-60">
                                <div class="w-full lg:w-6/12 px-4">
                                    ...
                                    transition-all duration-150">
                                            {{$this->application->tenure}} Months
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div class="w-full lg:w-6/12 px-4">
                                    ...
                                    text-lg tracking-tight text-gray-900 leading-tight" htmlfor="grid-password">
                                        ...
                                        @php
                                            $totalValue = 0;
                                        @endphp
                                        @foreach(\Illuminate\Support\Facades\DB::table('pledges')->where('application_id',$this->application->id)->get() as $pledge)
                                            @if($pledge)
