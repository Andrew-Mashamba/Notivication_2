    ...
    @if($edit_package)
        @foreach ( $jsonArray as $key => $value)
            ...
            @if($process_name == 'editUser')
             ...
             @if( App\Models\Role::where('id', App\Models\User::where('id', $process_id)->value($key))->value('department_name') ==
                App\Models\Role::where('id', $value)->value('department_name') )
             @else
            <div class="bg-gray-200 rounded-lg p-2 m-2" style="width: 40px; background-color: red;">
                    ...
                    <table class="w-full border-collapse border border-gray-300 mt-4 rounded-2xl">
                        ...
                        <tr>
                            ...
                            <td class="ml-2 py-2 px-4 border border-gray-300">
                                ...
                                {{ App\Models\Role::where('id', App\Models\User::where('id', $process_id)->value($key))->value('department_name')  }}
                            </td>
                        </tr>
                        <tr>
                            <td class="py-2 px-4 border border-gray-300">
