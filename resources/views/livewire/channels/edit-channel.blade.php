    ...
    <div class="bg-gray-100 rounded-lg shadow-sm ">
        <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
            <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                ...
                <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">SELECT A CHANNEL</p>
                ...
                @if($this->channelToEdit != null)
                    ...
                    <p for="name" class="block mb-2 mt-4 text-sm font-medium yellow dark:text-gray-400">CHANGE CHANNEL NAME</p>
                    <input type="text" id="serviceName" name="serviceName"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    ...
                    <p for="NewService" class="block mb-2 mt-4 text-sm font-medium yellow dark:text-gray-400">ADD A SERVICE</p>
                    <select wire:model.bounce="NewService" name="NewService" id="NewService" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="w-2/3 bg-white rounded px-6 rounded-lg shadow-sm  pt-4 pb-4  " >
                ...
                <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">CHANNEL SERVICES</p>
                                ...
                                <tr class=" flex border-b border-gray-200 dark:border-gray-900 w-full">
                                            ...
                                            <div aria-label="briefcase icon" role="img" tabindex="0" class="flex items-center justify-center w-8 h-8 bg-blue-100 rounded focus:outline-none">
                                                <button type="button" class="relative inline-flex items-center p-1 text-sm font-medium text-center text-white  rounded-full bg-blue-100 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         viewBox="0 0 24 24" stroke-width="1.5" stroke="#DD0035" class="w-8 h-8">
                                    ...
                                    <td class="px-4 py-4 sm:px-6 w-1/4 text-center">
                                        ...
                                        <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                             stroke-width="1.5" stroke="#DD0035" class="p-2 rounded-full cursor-pointer h-9 bg-red-100 stroke-slate-400 block mx-auto">
