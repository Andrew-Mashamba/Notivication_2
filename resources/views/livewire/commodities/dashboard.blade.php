                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                ...
                                <p class="text-gray-600 text-4xl font-bold">
                                    {{DB::table('commodities')->get()->count()}}
                                </p>
                            </div>

                            <!-- Total Value of Pledged Stock -->
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Active Commodities</h3>
                                <p class="text-gray-600">
                                    {{DB::table('commodities')->where('Status','ACTIVE')->get()->count()}}
                                </p>
                            </div>

                            <!-- Visual Representation of Stock Distribution (Placeholder) -->
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Suspended Commodities</h3>
                                <p class="text-gray-600">
                                    {{DB::table('commodities')->where('Status','PENDING')->get()->count()}}
                                </p>
                            </div>
