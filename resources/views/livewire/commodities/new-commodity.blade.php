                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <form>
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="relative w-4/12 px-4">
                                <label class="block text-blueGray-600 text-sm font-bold mb-2 font-medium text-lg tracking-tight text-gray-900 leading-tight" for="marital_status">
                                    Unity  Of Measurement
                                </label>
                                <select wire:model="unit" id="unit"
                                        class="border border-gray-300  shadow-sm px-4 py-2  font-medium placeholder-blueGray-300 text-blueGray-600 bg-white
                                      rounded-3xl text-sm shadow  w-full ease-linear transition-all duration-150">
                            ...
                            <div class="w-4/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input wire:model="price_per_kilo" type="number" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600
                                    bg-white rounded-3xl text-sm shadow focus:outline-none focus:ring w-full ease-linear
