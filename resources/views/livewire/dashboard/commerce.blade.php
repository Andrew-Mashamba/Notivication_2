                ...
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center">
                        ...
                        <div wire:loading.remove wire:target="visit(1)">
                            ...
                            <div class="flex items-center text-l font-semibold spacing-sm text-blue-800">New Applications
                    ...
                    <div class="flex items-center space-x-5" >
                        ...
                        <svg wire:click="visit(1)" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full bg-blue p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                ...
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center">
                        ...
                        <div wire:loading.remove wire:target="visit(2)">
                            ...
                            <div class="flex items-center text-l font-semibold spacing-sm text-blue-800">OnProgress
                    ...
                    <div class="flex items-center space-x-5" >
                        ...
                        <svg wire:click="visit(2)" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full bg-blue p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                ...
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center">
                        ...
                        <div wire:loading.remove wire:target="visit(3)">
                            ...
                            <div class="flex items-center text-l font-semibold spacing-sm text-blue-800">Awaiting For Approval
                    ...
                    <div class="flex items-center space-x-5" >
                        ...
                        <svg wire:click="visit(3)" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full bg-blue p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                ...
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center">
                        ...
                        <div wire:loading.remove wire:target="visit(4)">
                            ...
                            <div class="flex items-center text-l font-semibold spacing-sm text-blue-800">Awaiting Disbursement
                    ...
                    <div class="flex items-center space-x-5" >
                        ...
                        <svg wire:click="visit(4)" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full bg-blue p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                ...
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center">
                        ...
                        <div wire:loading.remove wire:target="visit(5)">
                            ...
                            <div class="flex items-center text-l font-semibold spacing-sm text-blue-800">Client Rejected
                    ...
                    <div class="flex items-center space-x-5" >
                        ...
                        <svg wire:click="visit(5)" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full bg-blue p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                ...
                <div class="flex justify-between items-center w-full">
                    <div class="flex items-center">
                        ...
                        <div wire:loading.remove wire:target="visit(6)">
                            ...
                            <div class="flex items-center text-l font-semibold spacing-sm text-blue-800">Active Loans
                    ...
                    <div class="flex items-center space-x-5" >
                        ...
                        <svg wire:click="visit(6)" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full bg-blue p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
