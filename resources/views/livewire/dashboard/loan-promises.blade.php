        ...
        <div class="w-full rounded-lg flex bg-white p-8 ">
            ...
            <ol class="items-center w-full flex space-x-4">
                ...
                <li class="relative w-full mb-6 sm:mb-0">
                    <div class="flex items-center">
                        <div class="z-10 flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0">
                            <svg class="w-2.5 h-2.5 text-blue-800 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#DD0035" viewBox="0 0 20 20">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold yellow dark:text-white">Current Loans</h3>
                ...
                <li class="relative w-full mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold yellow dark:text-white">Especially Mentioned</h3>
                ...
                <li class="relative w-full mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold yellow dark:text-white">Substandard</h3>
                ...
                <li class="relative w-full mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold yellow dark:text-white">Doubtful</h3>
                ...
                <li class="relative w-full mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pe-8">
                        <h3 class="text-lg font-semibold yellow dark:text-white">Loss</h3>
