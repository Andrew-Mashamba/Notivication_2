...
<div>
                                            ...
                                            <div class="space-y-0.5 flex-1 cursor-pointer">
                                                ...
                                                <div class="grid grid-cols-2 divide-x-2 mt-4">
                                                    <div class="pl-2 pr-2">
                                                        <div class="item">
                                                            <dt class="mb-2 text-xl font-extrabold">
                                                                {{number_format(DB::table('farmers')->where('Status','ACTIVE')->count())}}
                                                            </dt>
                                                    ...
                                                    <div class="pl-2 pr-2">
                                                        <div class="item">
                                                            <dt class="mb-2 text-xl font-extrabold">
                                                                {{number_format(DB::table('farmers')->where('Status','PENDING')->count())}}
                                                            </dt>
                                                            <dd class="text-gray-500 dark:text-gray-400">
                                                                <h3 class="font-medium text-sm tracking-tight text-gray-900 leading-tight">
                                                                    Failed
                                                ...
                                                <div class="bottom-section">
                                                    ...
                                                    <div class="grid grid-cols-2 divide-x-2 mt-4">
                                                        ...
                                                        <div class="pl-2 pr-2">
                                                            <div class="item">
                                                                <dt class="mb-2 text-3xl font-extrabold">
                                                                    {{ number_format(DB::table('stocks')->where('status', 'PLEDGED')->selectRaw('SUM(kilos * price_per_kilo) as total_value')->value('total_value'), 2) }}
                                                                </dt>
                                                                <dd class="text-gray-500 dark:text-gray-400">
                                                                    <h3 class="font-medium text-lg tracking-tight text-gray-900 leading-tight">
                                                                        Total Emails
                                            ...
                                            <div class="space-y-0.5 flex-1 cursor-pointer">
                                                ...
                                                <div class="grid grid-cols-2 divide-x-2 mt-4">
                                                    <div class="pl-2 pr-2">
                                                        <div class="item">
                                                            <dt class="mb-2 text-xl font-extrabold">
                                                                {{number_format(DB::table('collateral_managers')->where('Status','ACTIVE')->count())}}
                                                            </dt>
                                                            <dd class="text-gray-500 dark:text-gray-400">
                                                                <h3 class="font-medium text-sm tracking-tight text-gray-900 leading-tight">
                                                                    Sent
                                                    ...
                                                    <div class="pl-2 pr-2">
                                                        <div class="item">
                                                            <dt class="mb-2 text-xl font-extrabold">
                                                                {{number_format(DB::table('collateral_managers')->where('Status','PENDING')->count())}}
                                                            </dt>
                                                            <dd class="text-gray-500 dark:text-gray-400">
                                                                <h3 class="font-medium text-sm tracking-tight text-gray-900 leading-tight">
                                                                    Failed
    ...
    <script>
        ...
        var optionsx = {
            ...
            series: [
                ...
                {{ $clientsSummary['Resting'] }},
                {{ $clientsSummary['Pending'] }},
            ],
            colors: [
                '#ff4370', // Darker Blue
                '#DD0035', // Lighter Blue
    ...
    <script>
       // document.addEventListener('DOMContentLoaded', function () {
            const commodityValues = @json($commodityValues);
