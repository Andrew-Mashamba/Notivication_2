<div>
    <div class="p-2">
{{--Welcome banner--}}
        <div class="relative p-4 mb-2 pb-10 overflow-hidden rounded-lg bg-white" >
            ...
            <div class="relative w-full">
                <div class="min-w-full text-center text-sm font-light">
                    <div class="text-xl text-slate-400 font-bold mb-6 ">
...
{{--                            clients display here--}}
                            Total Clients: {{ (\App\Models\ClientsModel::where('loan_officer', auth()->user()->nida_number))->count() }}
                        </li>
                    </ul>
                </div>
