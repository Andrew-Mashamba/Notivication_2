<div class="lg:w-2/3">
        ...
        <div>
                                    ...
                                    @foreach($this->products as $product)
                                        <tr>
                                            ...
                                            <td class="pl-2 mt-2 text-sm font-semibold spacing-sm  @if($this->item == 2) text-white @else text-slate-400 @endif  dark:text-white">
                                                ...
                                                <p> {{number_format(App\Models\AccountsModel::where('sub_product_number',$product->sub_product_id)->sum('balance'),2)}}</p>
                                            </td>
                                        </tr>
                                    @endforeach
                                </table>
            ...
            <div class="bg-white rounded rounded-lg shadow-sm p-4">
                ...
                @if($this->item == 1)
                    <livewire:deposits.number-of-products
                            exportable
                            searchable="sub_product_name"
                    />
                @else
                    <livewire:deposits.other-data
                            exportable
