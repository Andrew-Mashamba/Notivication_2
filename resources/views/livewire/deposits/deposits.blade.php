                ...
                <div class="flex items-center mb-2 space-x-2 text-sm font-semibold spacing-sm text-slate-600 h-auto">
                    ...
                    <div>
                        ...
                        <table class="min-w-full text-center text-sm font-light">
                            <thead>
                                <tr>
                                    <th>DEPOSITS MANAGEMENT</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Active Deposits</td>
                                    <td class="whitespace-nowrap text-left">{{ $this->activeDepositsCount }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Inactive Deposits</td>
                                    <td class="whitespace-nowrap text-left">{{ $this->inactiveDepositsCount }}</td>
                                </tr>
                            </tbody>
                        </table>
...
<x-jet-dialog-modal wire:model="showCreateNewDepositsAccount">
    <x-slot name="title">
                ...
                <div class="w-full bg-white  p-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">DepositsAccount Name</p>
                            ...
                            <p for="region" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Region</p>
                            ...
                            <p for="wilaya" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Wilaya</p>
                            ...
                            <p for="membershipNumber" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Clientship Number</p>
                            ...
                            <p for="parentDepositsAccount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Parent DepositsAccount</p>
                            <select wire:model.bounce="parentDepositsAccount" name="parentDepositsAccount" id="parentDepositsAccount" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected value="">Select</option>
                                @foreach(App\Models\DepositsModel::all() as $DepositsAccount)
                                <option value="{{$DepositsAccount->id}}">{{$DepositsAccount->name}}</option>
                                @endforeach

                            </select>
                            @error('parentDepositsAccount')
                            <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                                <p>The Parent DepositsAccount is mandatory.</p>
                            </div>
                            @enderror
                            <div class="mt-2"></div>
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showCreateNewDepositsAccount')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
...
<!-- Log Out Other Devices Confirmation Modal -->
<x-jet-dialog-modal wire:model="showDeleteDepositsAccount">
    <x-slot name="title">
        ...
        <div>
            ...
            <div class="flex w-full">
                ...
                <div class="w-full p-4 ">
                    ...
                    @if($this->DepositsAccountSelected)




                        <p  class="block mb-1 text-sm capitalize text-slate-400 dark:text-white ">DepositsAccount SELECTED</p>
                        <div class="flex items-center mb-2 text-sm spacing-sm text-slate-600 mt-2" >
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <p>{{ App\Models\DepositsModel::where('id', $this->DepositsAccountSelected)->value('name') }}</p>

                        </div>

                        <div class="mt-4 w-full">
                            <p for="DepositsAccountSelected" class="block mb-1 text-sm capitalize text-slate-400 dark:text-white ">SELECT ACTION</p>
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showDeleteDepositsAccount')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-jet-secondary-button>
...
<!-- Log Out Other Devices Confirmation Modal -->
<x-jet-dialog-modal wire:model="showEditDepositsAccount">
    <x-slot name="title">
        ...
        <div>
            ...
            @endif
                ...
                <div class="bg-white p-4">
                    ...
                    <div class="mb-4">
                        <h5 >
                            EDIT DepositsAccount : {{$this->pendingDepositsAccountname}}
                        </h5>
                    </div>
                    ...
                    <div >
                        ...
                        <!-- Name -->
                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="name" value="{{ __('DepositsAccount Name') }}" />
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showEditDepositsAccount')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-jet-secondary-button>
        <div wire:loading.remove wire:target="updateDepositsAccount" >
            <x-jet-button class="ml-3"
                          wire:click="updateDepositsAccount"
                          wire:loading.attr="disabled">
                {{ __('Proceed') }}
            </x-jet-button>
        </div>
        <div wire:loading wire:target="updateDepositsAccount">
            <x-jet-button class="ml-3 "  >
                <svg aria-hidden="true" role="status" class="inline w-4 h-4 mr-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                    <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="#DD0035"/>
...
<!-- Log Out Other Devices Confirmation Modal -->
<x-jet-dialog-modal wire:model="showAddDepositsAccount">
    <x-slot name="title">
                        ...
                        <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                            ...
                            <div class="flex items-stretch">
                                ...
                                <div class="w-1/2 mr-2" >
                                    ...
                                    <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Select Client</p>
                                    <select wire:model.bounce="member" name="member" id="member" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected value="">Select</option>
                                    ...
                                    @if($this->member)
                                        <div class="flex justify-between">
                                            <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Existing deposit accounts</p>
                                            <div>
                                                @foreach(App\Models\AccountsModel::where('member_number',$this->member)->where('product_number','13')->get() as $account)
                                                    @php
                                    ...
                                    <p for="product" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Product</p>
                                    <select wire:model.bounce="product" name="product" id="product" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected value="">Select</option>
                                        @foreach(App\Models\sub_products::where('product_id','13')->get() as $product)
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showAddDepositsAccount')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-jet-secondary-button>
        <div wire:loading.remove wire:target="saveDeposit" >
            <x-jet-button class="ml-3"
        ...
        <div wire:loading wire:target="saveDeposit">
            <x-jet-button class="ml-3 "  >
                <svg aria-hidden="true" role="status" class="inline w-4 h-4 mr-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                    <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="#DD0035"/>
...
<!-- Log Out Other Devices Confirmation Modal -->
<x-jet-dialog-modal wire:model="showIssueNewDeposits">
    <x-slot name="title">
            ...
            <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                ...
                <div class="flex items-stretch">
                    ...
                    <div class="w-1/2 mr-2" >
                        ...
                        <p for="bank" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Select Bank</p>
                        <select wire:model.bounce="bank" name="bank" id="bank" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value="">Select</option>
                        ...
                        <p for="reference_number" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Enter Reference Number</p>
                        ...
                        @if($this->member)
                            ...
                            <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Deposits Accounts</p>
                            @foreach(App\Models\AccountsModel::where('member_number',$this->member)->where('product_number','13')->get() as $account)
                                @php
                                    $this->account_number = $account->account_number;
                                @endphp
                                <div class="flex items-center justify-between">
                                    ...
                                    @if($this->accountSelected == $account->account_number)
                                        <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full stroke-blue-400 p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                                        </svg>
                                    @else
                                        <div wire:loading.remove wire:target="setAccount({{$account->account_number}})">
                                            <svg wire:click="setAccount({{$account->account_number}})" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-9 bg-slate-50 rounded-full stroke-slate-400 p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                                    ...
                                    <div wire:loading wire:target="setAccount({{$account->account_number}})" >
                                        <svg xmlns="http://www.w3.org/2000/svg" class="animate-spin  h-5 w-5 mr-2 stroke-gray-400" fill="white" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                        ...
                        @if($this->accountSelected)
                            ...
                            <p for="amount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Enter Amount</p>
                            ...
                            <p for="notes" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Enter Notes</p>
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showIssueNewDeposits')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-jet-secondary-button>
