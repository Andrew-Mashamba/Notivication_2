            ...
            <x-slot name="content">
                            ...
                            <option value="{{ $category->category_name }}">
                                    <div class="py-3 sm:py-4">
                                        <div class="items-center space-x-4">
                                            ...
                                            <div class="min-w-0">
                                                <div class="text-sm font-medium yellow truncate dark:text-white">
                ...
                ->first()
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <textarea id="notes" name="notes" wire:model.defer="notes" rows="4" class="mt-1 block p-2.5 w-full text-sm yellow bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Your notes..."></textarea>
                        @error('notes')
