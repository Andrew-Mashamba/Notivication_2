            ...
            <div>
                ...
                <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                    ...
                    <li class="flex items-center">
                        ...
                        Total role: {{  App\Models\departmentsList::count() }}
                    </li>
                    <li class="flex items-center">
...
{{--                        </button>--}}
                    ...
                    @endif
                    @if($this->tab_id==3)
                            @if (in_array( "Create and edit role" , session()->get('permission_items')))
                ...
                <div>
                    ...
                    <div class=" p-4">
                        <div class="flex items-center space-x-5" hidden>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" wire:click="homeButton()" class="cursor-pointer h-12 bg-slate-50 rounded-full stroke-red-400 p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                            ...
                            <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                                ...
                                <div class="flex items-stretch">
                                    <div class="w-1/2 mr-2" >
                                        ...
                                        <select wire:model="branch" name="branch" id="branch" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                        ...
                                        <p for="branch" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Role</p>
                                        <select wire:model="role" name="branch" id="branch" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                            <option value="" selected>Select</option>
                                            @foreach(DB::table('roles')->get() as $branch)
                                    ...
                                    <div class="w-1/2 ml-2" >
                                        ...
                                        <select wire:model.bounce="gender" name="gender" id="gender" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                        ...
                                        <select wire:model.bounce="marital_status" name="marital_status" id="marital_status" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                            <option selected value="">Select</option>
                                        ...
                                        <textarea id="notes" name="notes" wire:model.defer="notes" rows="5" class="mt-1 block p-2.5 w-full text-sm yellow bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Your notes..."></textarea>
                                        @error('notes')
                                        <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
