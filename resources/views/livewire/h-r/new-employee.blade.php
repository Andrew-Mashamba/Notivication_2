<div class=" w-full  ">
    <div class="flex float-right">
        ...
        <button class="p-2 mr-6 " wire:click="removeEmployeeRegistrationForm">
            <svg fill="none" stroke="#DD0035" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path stroke-linecap="round" fill="bg-blue-100" stroke-linejoin="round" d="M12 9.75L14.25 12m0 0l2.25 2.25M14.25 12l2.25-2.25M14.25 12L12 14.25m-2.58 4.92l-6.375-6.375a1.125 1.125 0 010-1.59L9.42 4.83c.211-.211.498-.33.796-.33H19.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-9.284c-.298 0-.585-.119-.796-.33z"></path>
            </svg>
            back
        ...
        <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                                ...
                                <label class="flex flex-col w-full h-19 hover:bg-gray-100 hover:border-gray-300">
                                    <div class="flex flex-col items-center justify-center pt-7">
                                        ...
                                        <div wire:loading wire:target="photo" class="" >
                                            ...
                                            <svg style="width: 50%; margin: 0 auto;" xmlns="http://www.w3.org/2000/svg" class="animate-spin  w-8 h-8 text-gray-400 group-hover:text-gray-600" fill="white" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                                        ...
                                        <div wire:loading.remove wire:target="photo" class="flex flex-col items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-400 group-hover:text-gray-600"
                                                 fill="none" viewBox="0 0 24 24" stroke="#DD0035">
            ...
            <div class="flex items-stretch">
                ...
                <div class="w-1/2 mr-2" >
                    ...
                    <p for="branch" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Branch</p>
                    ...
                    <p for="Employment_type" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Employment Type</p>
                    <select wire:model.bounce="Employment_type" name="Employment_type" id="Employment_type" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <p for="role" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Role</p>
                    <select wire:model.bounce="role" name="Employment_type" id="Employment_type" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="">Select</option>
                            <?php $departments =DB::table('roles')->get() ?>
                    ...
                    <p for="first_name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Job Title</p>
                    ...
                    <p for="first_name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">First Name</p>
                    ...
                    <x-jet-label for="contributions" value="{{ __('contributions') }}" />
                    <select wire:model.bounce="contributions" name="contributions" id="contributions" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="">Select ......</option>
                        @foreach(DB::table('Contributions')->get() as $contribution)
                            <option value="{{$contribution->id}}">{{$contribution->name}}  : {{$contribution->amount}}</option>
                        @endforeach
                    </select>
                    @error('contributions')
                    <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                        <p>contributions is mandatory and should be more than three characters.</p>
                    </div>
                    @enderror
                    <div class="mt-2"></div>
                ...
                <div class="w-1/2 ml-2" >
                    ...
                    <select wire:model.bounce="gender" name="gender" id="gender" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="">Select</option>
                    ...
                    <select wire:model.bounce="marital_status" name="marital_status" id="marital_status" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="">Select</option>
                    ...
                    <x-jet-label for="benefits" value="{{ __('Benefits') }}" />
                    <select wire:model.bounce="benefits" name="benefits" id="benefits" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="">Select ......</option>
                        @foreach(DB::table('benefits')->get() as $contribution)
                            <option value="{{$contribution->id}}">{{$contribution->name}}  : {{$contribution->amount}}</option>
                        @endforeach
                    </select>
                    @error('benefits')
                    <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                        <p>benefits Salary is mandatory and should be more than three characters.</p>
                    </div>
                    @enderror
                    <div class="mt-2"></div>
                    ...
                    <x-jet-label for="taxes" value="{{ __('Taxes') }}" />
                    <select wire:model.bounce="taxes" name="contributions" id="contributions" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="">Select ......</option>
                        @foreach(DB::table('taxes')->get() as $contribution)
                            <option value="{{$contribution->id}}">{{$contribution->name}}  : {{$contribution->amount}}</option>
                        @endforeach
                    </select>
                    @error('taxes')
                    <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                        <p>taxes Salary is mandatory and should be more than three characters.</p>
                    </div>
                    @enderror
                    <div class="mt-2"></div>
                ...
                <div wire:loading wire:target="save" >
                    <button class="text-white bg-blue-400 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-400 dark:hover:bg-blue-400 dark:focus:ring-blue-400" disabled>
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="animate-spin  h-5 w-5 mr-2 stroke-white-800" fill="white" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
