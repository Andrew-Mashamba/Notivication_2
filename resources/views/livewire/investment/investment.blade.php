                ...
                <div class="w-full bg-white  p-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Investment Name</p>
                            ...
                            <p for="region" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Investment Type</p>
                            ...
                            <p for="region" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Expense Account</p>
                            ...
                            <p for="investment_amount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Investment Amount</p>
