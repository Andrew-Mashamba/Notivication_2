        ...
        <div class="bg-gray-100 rounded rounded-lg shadow-sm ">
            <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
                <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                    <input type="file" wire:model="loan_document" class=" bg-gray-50 border border-gray-300 yellow sm:text-xs   rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white p-1 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <textarea id="notes" name="notes" wire:model="document_descriptions" rows="5" class="mt-1 block p-2.5 w-full text-sm yellow bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your notes..."></textarea>
                            ...
                            <div class="w-full bg-white rounded rounded-lg h-50 shadow-sm  flex space-x-1  p-2 ">
                                <div class="w-1/2">
                                   ...
                                   <div class="flex gap-6">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#DD0035" class="bi bi-clipboard" viewBox="0 0 16 16">
