    ...
    <div class="bg-gray-100 rounded rounded-lg shadow-sm ">
        <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
            <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                ...
                <p for="collateral_type" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Loan Product</p>
            ...
            <div class="w-2/3 bg-white rounded px-6 rounded-lg shadow-sm  pt-4 pb-4  " >
                ...
                <p for="stability" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">STABILITY OF THE BUSINESS</p>
                ...
                <p for="stability2" class="block mt-2 text-sm font-medium yellow dark:text-gray-400">ABILITY TO PAY</p>
