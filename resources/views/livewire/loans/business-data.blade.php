        ...
        <div class="bg-gray-100 rounded rounded-lg shadow-sm ">
            ...
            <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
                ...
                <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                    ...
                    <p for="business_name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Business Name</p>
                    <input type="text" id="business_name" name="business_name"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    ...
                    <p for="business_age" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Age of the business</p>
                    <input type="number" id="business_age" name="business_age"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="business_category" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Business Category</p>
                    <select wire:model.bounce="business_category" name="business_category" id="business_category" class="bg-gray-50
                    border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full
                    ...
                    <p for="business_type" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Business Type</p>
                    <input type="text" id="business_type" name="business_type"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="business_licence_number" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Business Licence Number</p>
                    <input type="text" id="business_licence_number" name="business_licence_number"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="business_tin_number" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Business TIN Number</p>
                    <input type="text" id="business_tin_number" name="business_tin_number"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="business_inventory" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Business Inventory</p>
                    <input type="number" id="business_inventory" name="business_inventory"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="cash_at_hand" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Cash At Hand</p>
                    <input type="number" id="cash_at_hand" name="cash_at_hand"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="daily_sales" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Daily Average Sales</p>
                    <input type="number" id="daily_sales" name="daily_sales"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="cost_of_goods_sold" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Cost Of Sales Per Month</p>
                    <input type="number" id="cost_of_goods_sold" name="cost_of_goods_sold"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="operating_expenses" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Operating Expenses</p>
                    <input type="number" id="operating_expenses" name="operating_expenses"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="monthly_taxes" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Taxes Per Month</p>
                    <input type="number" id="monthly_taxes" name="monthly_taxes"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <p for="other_expenses" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Other Expenses</p>
                    <input type="number" id="other_expenses" name="other_expenses"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="flex justify-center m-8">
                            <div class="max-w-2xl rounded-lg shadow-sm bg-gray-50">
                                <div class="m-4">
                                    ...
                                    <a wire:click="saveImage" class="ml-2 inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                    ...
                    <div class="w-full">
                        ...
                        <div class="gridx max-w-4xl mx-auto">
                            ...
                            <div  class="bg-white rounded h-full text-grey-darkest no-underline shadow-md w-64">
                                ...
                                <svg wire:click="close({{ $image->id }})" xmlns="http://www.w3.org/2000/svg" class=" object-right h-12 w-12 bg-slate-50 rounded-full stroke-red-400 p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
