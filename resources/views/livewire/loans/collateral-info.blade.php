    ...
    <div class="bg-gray-100 rounded rounded-lg shadow-sm ">
        ...
        <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
            ...
            <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                ...
                <p for="collateral_type" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Collateral Type</p>
                <select wire:model.bounce="collateral_type" name="collateral_type" id="collateral_type" class="bg-gray-50 border border-gray-300
                 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600
                ...
                <p for="collateral_description" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Collateral Description</p>
                <input type="text" id="collateral_description" name="collateral_description"  class="bg-gray-50 border border-gray-300 yellow text-sm
                ...
                <p for="collateral_location" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Collateral Location</p>
                <input type="text" id="collateral_location" name="collateral_location"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <p for="collateral_value" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Collateral Value</p>
                <input type="text" id="collateral_value" name="collateral_value"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
