        ...
        <div class="w-full" >
            ...
            <div class="h-16 border-b flex justify-between items-center w-full px-5 py-2 shadow-sm">
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <svg wire:click="close" xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 bg-slate-50 rounded-full stroke-red-400 p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
