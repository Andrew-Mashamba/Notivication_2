        ...
        <div class="w-full h-full grid justify-items-center">
            ...
            <div class="flex justify-center px-4 pt-4 pb-4">
                ...
                <div class=" flex flex-row gap-2">
                        ...
                        <input wire:model.live.debounce="client_number" type="number" id="client_number" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                        ...
                        <input wire:model.bounce="relationship" type="text" id="relationship" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                            bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4
                            focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600
                            dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700
                ...
                <div class="flex justify-end w-auto" >
                    <div wire:loading wire:target="set" >
                        <button class="ml-2 inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                            bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4
                            focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600
                            dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700
                ...
                <div class="flex justify-end w-auto" >
                    <div wire:loading.remove wire:target="set" >
                        <button wire:click="set" class="ml-2 inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                            bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4
                            focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600
                            dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700
                                                ...
                                                <div class="metric-card  dark:bg-gray-900 border bg-white  border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72 w-full" >
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr class="whitespace-nowrap">
                                                            ...
                                                            <td class="px-6 py-4">
                                                                <p class="text-sm yellow whitespace-normal">
