    ...
    <div>
        ...
        <div class="w-full">
            ...
            <div class="flex justify-center px-4 pt-4">
                <div>
                    <input wire:model.bounce="member_number" type="text" id="first_name" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                    ...
                    <select wire:model.bounce="product_number" name="product_number" id="product_number" class="ml-2 inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                            bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4
                            focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600
                            dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700
                    ...
                    <a wire:click="set" class="pointer-cursor ml-2 inline-flex items-center py-2 px-4 text-sm font-medium text-center yellow
                            bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4
                            focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600
