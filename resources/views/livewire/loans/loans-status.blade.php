                ...
                <div class="flex flex-1 items-center justify-between">
                        ...
                        <div class="flex ">
                            <div class="flex space-x-4 pr-2">
                                ...
                                @else
                                <a href="#" wire:click="showTab('business')" class=" @if($this->activeTab == 'business') bg-red-500 text-white @endif  text-blue-800 hover:bg-red-600 text-blue-900  hover:text-white rounded-md px-3 py-2 text-sm font-medium">Business Information</a>
                            ...
                            <button type="button" class="rounded-full bg-white p-1 space-x-2 text-gray-400 hover:text-blue-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                <svg wire:click="close" xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 " fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
