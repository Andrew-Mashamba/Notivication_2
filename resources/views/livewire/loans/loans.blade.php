...
<div>
    <div class="w-full flex bg-gray-200 h-100">
                ...
                <div aria-label="card" class="p-6 rounded-3xl bg-white w-full min-h-screen">
                    ...
                    <div aria-label="content" class="mt-9 grid gap-2.5">
                        ...
                        <hr class="mt-2 mb-2 border-b-1 border-blueGray-300">
                            ...
                            <a wire:click="loadView(1)" class="cursor-pointer  ">
                                <div class="flex items-center space-x-4 p-2 @if($this->viewLoaded==1)  bg-blue-100  @endif rounded-3xl bg-gray-100">
                                <span class="flex items-center justify-center w-14 h-14 shrink-0 rounded-full bg-white yellow">
                                    ...
                                    <div class="flex flex-col flex-1">
                                        <h3 class="text-sm font-medium"> Stock Flow </h3>
                                        <div class="divide-x divide-gray-200 mt-auto">
                                            ...
                                            <span class="inline-block px-3 text-xs leading-none text-gray-400 font-normal first:pl-0">
                                              {{DB::table('stocks')->where('status','ACTIVE')->sum('kilos')}} kg
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <a wire:click="loadView(2)"

                               class="cursor-pointer ">
                                <div class="flex items-center space-x-4 p-2 rounded-3xl bg-gray-100   @if($this->viewLoaded==2)  bg-blue-100   @endif ">
                                <span class="flex items-center justify-center w-14 h-14 shrink-0 rounded-full bg-white yellow">
                                    <img src="{{ asset('images/avatar.png') }}" class="rounded-full h-12" alt="Avatar Image" >
                                </span>
                                    <div class="flex flex-col flex-1">
                                        <h3 class="text-sm font-medium">Other Activities </h3>
                                        <div class="divide-x divide-gray-200 mt-auto">
                                             <span class="inline-block px-3 text-xs leading-none text-gray-400 font-normal first:pl-0">
                                               May need approvals
                                            </span>
        ...
        <div class="w-3/4">
            <div class="flex items-center justify-center min-h-screen bg-gray-200 p-2">
                <div aria-label="card" class="p-2 rounded-3xl bg-white w-full min-h-screen">
                    <div aria-label="header" class="flex items-center space-x-2">
                    ...
                    <div aria-label="content" class="mt-9 rounded-3xl shadow-md   overflow-x-auto gap-2.5 ">

                        <div wire:loading.remove wire:target="loadView">
                            @if($this->viewLoaded == "1")
                                <livewire:loans.loans-table />
                            @elseif($this->viewLoaded == "2")
