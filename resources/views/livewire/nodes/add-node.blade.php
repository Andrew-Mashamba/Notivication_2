     ...
     <div>
         <div class="flex w-full gap-4">
             <div class="w-1/2">
                 ...
                 <select wire:model.bounce="nodeType" name="nodeType" id="nodeType" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
             ...
             <div class="w-1/2">
                 ...
                 <div class="flex justify-between w-full gap-4" id="DATASOURCETYPE">
                     ...
                     <div class="flex items-center w-1/3 pl-4 ">
                         <input wire:model='DATASOURCETYPE' id="bordered-radio-1" type="radio" value="Portal" name="DATASOURCETYPE" class="clearerror w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked>
                         <p for="bordered-radio-1" class="w-full py-4 ml-2 text-sm font-medium yellow dark:text-gray-300">Portal</p>
                     </div>
                     <div class="flex items-center w-1/3 pl-4 ">
                         <input checked wire:model='DATASOURCETYPE' id="bordered-radio-2" type="radio" value="Database" name="DATASOURCETYPE" class="clearerror w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                         <p for="bordered-radio-2" class="w-full py-4 ml-2 text-sm font-medium yellow dark:text-gray-300">Database</p>
                     </div>
                     <div class="flex items-center w-1/3 pl-4 ">
                         <input wire:model='DATASOURCETYPE' id="bordered-radio-1" type="radio" value="API" name="DATASOURCETYPE" class="clearerror w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                         <p for="bordered-radio-1" class="w-full py-4 ml-2 text-sm font-medium yellow dark:text-gray-300">API</p>
                     </div>
         ...
         <div class="flex w-full gap-4">
             <div class="w-1/2">
                 ...
                 <div class="" id="NODE_NAME">
                     <input  id="NODE_NAME" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="NODE_NAME" autocomplete="NODE_NAME" />
                 ...
                 <div class="" id="DB_TABLE_REFERENCE">
                     <input id="DB_TABLE_REFERENCE" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_REFERENCE" autocomplete="DB_TABLE_REFERENCE" />
                 ...
                 <div class="" id="DB_TABLE_SECONDARY_REFERENCE">
                     <input id="DB_TABLE_SECONDARY_REFERENCE" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_SECONDARY_REFERENCE" autocomplete="DB_TABLE_SECONDARY_REFERENCE" />
                 </div>
                 ...
                 <div class="" id="DB_TABLE_DATE">
                     <input id="DB_TABLE_DATE" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_DATE" autocomplete="DB_TABLE_DATE" />
                 ...
                 <div class="" id="DB_TABLE_AMOUNT">
                     <input id="DB_TABLE_AMOUNT" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_AMOUNT" autocomplete="DB_TABLE_AMOUNT" />
                 ...
                 <div class="" id="DB_TABLE_SENDER">
                     <input id="DB_TABLE_SENDER" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_SENDER" autocomplete="DB_TABLE_SENDER" />
                 ...
                 <div class="" id="DB_TABLE_RECEIVER">
                     <input id="DB_TABLE_RECEIVER" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_RECEIVER" autocomplete="DB_TABLE_RECEIVER" />
                 ...
                 <div class="" id="DB_TABLE_STATUS">
                     <input id="DB_TABLE_STATUS" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_STATUS" autocomplete="DB_TABLE_STATUS" />
                 ...
                 <div class="" id="DB_TABLE_SERVICE_IDENTIFIER">
                     <input id="DB_TABLE_SERVICE_IDENTIFIER" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_SERVICE_IDENTIFIER" autocomplete="DB_TABLE_SERVICE_IDENTIFIER" />
             ...
             <div class="w-1/2">
                 ...
                 <div class="" id="DB_TABLE_CLIENT_IDENTIFIER">
                     <input id="DB_TABLE_CLIENT_IDENTIFIER" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_CLIENT_IDENTIFIER" autocomplete="DB_TABLE_CLIENT_IDENTIFIER" />
                 ...
                 <div class="" id="DB_TABLE_TRANSACTION_TYPE">
                     <input id="DB_TABLE_TRANSACTION_TYPE" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_TRANSACTION_TYPE" autocomplete="DB_TABLE_TRANSACTION_TYPE" />
             ...
             @php $this->resetErrorBag(); @endphp
                            <p for="DB_TABLE_API_URL" class="block mb-1 mt-2 text-sm capitalize text-slate-400 dark:text-white ">API URL</p>
                             <div class="" id="DB_TABLE_API_URL">
                                 <input type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model.defer="DB_TABLE_API_URL" autocomplete="DB_TABLE_API_URL" />
                 ...
                 @php $this->resetErrorBag(); @endphp
                         ...
                         <div id="query" class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                             <div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                                 ...
                                 <button type="button" data-tooltip-target="tooltip-fullscreen" class="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:yellow hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                                     <svg aria-hidden="true" class="w-5 h-5" fill="#DD0035" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 4a1 1 0 011-1h4a1 1 0 010 2H6.414l2.293 2.293a1 1 0 11-1.414 1.414L5 6.414V8a1 1 0 01-2 0V4zm9 1a1 1 0 010-2h4a1 1 0 011 1v4a1 1 0 01-2 0V6.414l-2.293 2.293a1 1 0 11-1.414-1.414L13.586 5H12zm-9 7a1 1 0 012 0v1.586l2.293-2.293a1 1 0 111.414 1.414L6.414 15H8a1 1 0 010 2H4a1 1 0 01-1-1v-4zm13-1a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 010-2h1.586l-2.293-2.293a1 1 0 111.414-1.414L15 13.586V12a1 1 0 011-1z" clip-rule="evenodd"></path></svg>
            ...
            <div wire:loading wire:target="save" >
                <button class="px-4 py-2 text-sm font-medium text-white bg-blue-400 rounded-lg hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-400 dark:hover:bg-blue-400 dark:focus:ring-blue-400" disabled>
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 animate-spin stroke-white-800" fill="white" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
