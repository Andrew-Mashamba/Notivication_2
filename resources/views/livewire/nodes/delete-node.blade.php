            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                <div class="flex w-full">
                    ...
                    <div class="pr-4 w-1/2 ">
                        ...
                        <select wire:model="nodeSelected" name="nodeSelected" id="nodeSelected" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        @if($this->nodeSelected)
                            ...
                            <input wire:model.defer="password" id="current_password" type="password" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autocomplete="current-password" />
