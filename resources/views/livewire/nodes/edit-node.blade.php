    ...
    @endif
        ...
        <div class="bg-gray-100 rounded-lg shadow-sm p-2">
            ...
            <div class="pr-4 w-1/2 ">
                ...
                <select wire:model="nodeSelected" name="nodeSelected" id="nodeSelected" class="w-full bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
