                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <div class="flex justify-end">
                                                @if($order->order_status == 'Pending')
                                                    <div>
                                                        <span align="right" class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-200 dark:yellow">Pending </span>
                                                    </div>
                                                @endif
                                                @if($order->order_status == 'Pending Approval')
                                                    <div>
                                                ...
                                                @if($order->order_status == 'Processed')
                                                    <div>
                                                        <span align="right" class="bg-blue-100 text-white-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-white-900">Processed</span>
                                                    </div>
                                                @endif
...
<div>
    <x-jet-dialog-modal id="xxxx" wire:model="modal" wire:ignore.self >
        ...
        <x-slot name="content">
            ...
            <button wire:click="closeEditEntryModal" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:yellow rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="authentication-modal">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium yellow dark:text-white">Update entry</h3>
    ...
    <x-jet-dialog-modal id="xxx" wire:model="deleteOrderModal" wire:ignore.self >
        ...
        <x-slot name="content">
            ...
            <button type="button" wire:click="closeDeleteOrderModal" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:yellow rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="authentication-modal">
                <svg class="w-5 h-5" fill="#DD0035" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
            <div class="py-6 px-6 lg:px-8">
