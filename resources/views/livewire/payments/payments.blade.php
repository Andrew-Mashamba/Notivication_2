...
{{--                        @if (in_array(23, session()->get('permissions')))--}}
                        <button wire:click="menuItemClicked(2)" class="mr-4 flex text-center items-center @if($this->tab_id == 2) bg-blue-100 @else bg-gray-100  @endif @if($this->tab_id == 2) text-blue-900 font-bold  @else  text-gray-400 font-semibold   @endif  py-2 px-4 rounded-lg" onmouseover="this.style.backgroundColor='#00FFBF'; this.style.color='';" onmouseout="this.style.backgroundColor=''; this.style.color='';">
...
{{--                    @if (in_array(23, session()->get('permissions')))--}}
                    <button wire:click="menuItemClicked(3)" class="mr-4 flex text-center items-center @if($this->tab_id == 3) bg-blue-100 @else bg-gray-100  @endif @if($this->tab_id == 3) text-blue-900 font-bold  @else  text-gray-400 font-semibold   @endif  py-2 px-4 rounded-lg" onmouseover="this.style.backgroundColor='#00FFBF'; this.style.color='';" onmouseout="this.style.backgroundColor=''; this.style.color='';">
...
{{--                @if (in_array(23, session()->get('permissions')))--}}
                <button wire:click="menuItemClicked(4)" class="mr-4 flex text-center items-center @if($this->tab_id == 4)bg-blue-100 @else bg-gray-100  @endif @if($this->tab_id == 4) text-blue-100 font-bold  @else  text-gray-400 font-semibold   @endif  py-2 px-4 rounded-lg" onmouseover="this.style.backgroundColor='#00FFBF'; this.style.color='';" onmouseout="this.style.backgroundColor=''; this.style.color='';">
