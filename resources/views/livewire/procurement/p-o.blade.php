                    ...
                    <div class="flex justify-between bg-blue-100 rounded-lg text-white p-2 ">
                       <div class="float-right flex">
                        <button type="button" class="rounded-full  flex justify-end item-end bg-white p-1 text-gray-400 hover:text-blue-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                            <svg wire:click="$toggle('viewPoBoolean')" xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 " fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" wire:model="vendorId"  value="{{$vendor->id}}"
                                           class="
                                mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    >
                        ...
                        @enderror
                            ...
                            <input type="date" wire:model="endDate"
                                   class="
                                w-full mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
