            ...
            <div>
                ...
                <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                    ...
                    <li class="flex items-center">
                        ...
                        Updates
                        <span>
                                <span class="ml-2 bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400"> </span>
                            </span>
                    </li>
                </ul>
            </div>
...
{{--    top bar start--}}
    ...
    <div class="bg-white  overflow-hidden mb-2 rounded-lg">

        <div class="grid p-4 grid-cols-6 gap-2 p-2">
            @php
                $menuItems = [
                    ['id' => 1, 'label' => 'Purchase Requisition'],
                    ['id' => 2, 'label' => 'Vendor Managements'],
                    ['id' => 4, 'label' => 'Contract Management '],
                    ['id' => 5, 'label' => ' Tender Management'],
                    ['id' => 6, 'label' => ' Inventory Management'],
                    ['id' => 9, 'label' => 'Assets Management'],
                ];
            @endphp
        ...
        <div class="w-full   p-2" >
            ...
            @switch($this->tab_id)
                ...
                @break
                @case('7')
                <livewire:procurement.budget-table/>
                @break

{{--                @case('8')--}}
{{--                <livewire:procurement.invoice/>--}}
{{--                @break--}}
