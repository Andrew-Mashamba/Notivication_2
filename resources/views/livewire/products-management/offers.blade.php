                ...
                <div>
                    ...
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        ...
                        <li class="flex items-center">
                            ...
                            New Offers  <span>
                                <span class="ml-2 bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400"> {{ App\Models\OffersModel::where('offer_status','NEW OFFER')->count() }}</span>
                            </span>
                        </li>
                    </ul>
                </div>
