...
{{--        @endforeach--}}
        <div>
            <label class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Settings Status</label>
    ...
    <div class="flex gap-2">
        <div class="w-1/3" >
            <label for="currency" class="block mb-2 sm:text-xs  font-medium yellow dark:text-gray-400">Currency</label>
            ...
            <div>
                <label for="disbursement_account" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300"> Client Registration Fees</label>
            ...
            <x-jet-section-border />
            <div>
                <label for="collection_account_loan_interest" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Allocated shares</label>
            ...
            <div>
                <label for="collection_account_loan_principle" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Available shares</label>
            ...
            <div>
                <label for="collection_account_loan_charges" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Minimum shares</label>
            ...
            <div>
                <label for="collection_account_loan_penalties" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Value per shares</label>
        ...
        <div class="w-1/3 border-l pl-2">
            ...
            <div>
                <label for="collection_account_loan_charges" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Institution Name</label>
            ...
            <div>
                <label for="collection_account_loan_charges" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Email</label>
            ...
            <x-jet-section-border />
            <div>
                <label for="collection_account_loan_charges" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Phone Number</label>
            ...
            <x-jet-section-border />
            <div>
                <label for="collection_account_loan_charges" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Region</label>
            ...
            <div>
                <label for="collection_account_loan_charges" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Wilaya</label>
            ...
            <label for="repayment_frequency" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Repayment Frequency</label>
            ...
            <div class="flex items-center mb-4">
                ...
                <label for="create_during_registration" class="ml-2 sm:text-xs font-medium yellow dark:text-gray-300">Monthly</label>
            </div>
        ...
        <div class="w-1/3 border-l pl-2">
            ...
            <label for="small-input" class="block mb-2 sm:text-xs font-medium yellow dark:text-gray-300">Set  Client inactive after</label>
            <fieldset>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="country-option-1" class="block ml-2 sm:text-xs font-medium yellow dark:text-gray-300">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="country-option-2" class="block ml-2 sm:text-xs font-medium yellow dark:text-gray-300">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="country-option-3" class="block ml-2 sm:text-xs font-medium yellow dark:text-gray-300">
                ...
                <div class="flex items-center mb-4">
                    <input wire:model.defer="inactivity" id="inactivity_twenty_four_months"
                           type="radio" name="inactivity" value="24" class="w-4 h-4 border-gray-300 focus:ring-2
                                                   focus:ring:blue-300 dark:focus-ring-blue-600 dark:bg-gray-700 dark:border-gray-600">
                    <label for="country-option-4" class="block ml-2 sm:text-xs font-medium yellow dark:text-gray-300">
