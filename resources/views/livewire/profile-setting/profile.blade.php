        ...
        <x-slot name="content">
            ...
            <div class=" border border-blue-600 rounded-lg p-4">
                ...
                <ol class="items-center w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse flex justify-between">
                    <li class="flex items-center @if($currentStep === 1) text-blue-600 @else text-gray-500 @endif dark:text-blue-500 space-x-2.5 rtl:space-x-reverse">
                    ...
                    <li class="flex items-center  @if($currentStep === 2) text-blue-600 @else text-gray-500 @endif dark:text-gray-400 space-x-2.5 rtl:space-x-reverse">
                    ...
                    <li class="flex items-center  @if($currentStep === 3) text-blue-600 @else text-gray-500 @endif  dark:text-gray-400 space-x-2.5 rtl:space-x-reverse">
                    <span class="flex items-center justify-center w-8 h-8 border border-gray-500 rounded-full shrink-0 dark:border-gray-400">
                        3
                    </span>
                        <span>
                ...
                @if($currentStep === 1)
                    ...
                    @if ($application)
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title font-semibold text-blue-800">APPLICANT INFORMATION</h5>
                                    ...
                                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        ...
                                        @foreach (get_object_vars($application) as $field => $value)
                                            ...
                                            <tr class="flex w-full bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                <th scope="row" class="w-1/2 px-6 py-4 font-semibold yellow whitespace-nowrap dark:text-white">
                                ...
                                <h5 class="card-title font-semibold mt-4 text-blue-800">VEHICLE INFORMATION</h5>
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                @foreach ($soapResponse->childNodes as $childNode)
                                    ...
                                    <tr class="flex w-full bg-white border-b ">
                                        <th scope="row" class="w-1/3 px-6 py-4 font-semibold yellow whitespace-nowrap dark:text-white">
                ...
                @elseif($currentStep === 3)
                        ...
                        <!-- message container -->
                            ...
                            @endif
                                ...
                                <div class="w-full " >
                                    ...
                                    <p for="collateral_type" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Interest Method
                                    </p>
                                    ...
                                    <p for="principle_amount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Principle Amount</p>
                                    <input type="number" id="principle_amount" name="principle_amount"  class="bg-gray-50 border border-gray-300 yellow text-sm
                 ...
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="flex w-full space-x-4">
                                        ...
                                        <div class="w-1/2">
                                            <p for="tenure" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Interest</p>
                                            <input type="number" id="tenure" name="tenure" value="12" class="bg-gray-50 border border-gray-300 yellow text-sm
                 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        ...
                                        <div class="w-1/2">
                                            <p for="tenure" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Tenure</p>
                                            <input type="number" id="tenure" name="tenure" value="12" class="bg-gray-50 border border-gray-300 yellow text-sm
                 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        ...
                                        <div class="w-full bg-gray-50 rounded rounded-lg shadow-sm   p-1 " >
                                            ...
                                            <div class="w-full bg-white rounded rounded-lg shadow-sm   p-2 " >
                                                ...
                                                @if($this->future_interests=="NO")
                                                    <p for="principle_amount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400"></p>
                                                    <input type="number" id="principle_amount" name="principle_amount"  class="bg-gray-50 border border-gray-300 yellow text-sm
                 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    @if($this->topUpBoolena)
                                        ...
                                        <div class="w-full bg-gray-50 rounded rounded-lg shadow-sm   p-1 " >
                                            ...
                                            <div class="w-full bg-white rounded rounded-lg shadow-sm   p-2 " >
                                                ...
                                                <p for="principle_amount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">New Principle</p>
                                                <input type="number" id="principle_amount" name="principle_amount"  class="bg-gray-50 border border-gray-300 yellow text-sm
                 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                ...
                                                @if($this->future_interests=="NO")
                                                    <p for="principle_amount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Total Interest</p>
                                                    <input type="number" id="principle_amount" name="principle_amount"  class="bg-gray-50 border border-gray-300 yellow text-sm
                 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                           wire:model.lazy="futureInsteresAmount" required>
                                    ...
                                    <p for="stability" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">SECURITY COVERAGE</p>
                                    ...
                                    @if(Session::get('loanStatus') == 'ACTIVE')
                                        <div class="flex justify-end w-auto" >
                                            <div wire:loading.remove wire:target="actionBtns" >
                                                ...
                                                <button wire:click="actionBtns(55)" class="text-white bg-blue-400 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-400 dark:hover:bg-blue-400 dark:focus:ring-blue-400">
                                    ...
                                    @if(Session::get('loanStatus') == 'APPROVED')
                                        ...
                                        <select wire:model.bounce="bank1" name="bank1" id="bank1" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="w-full bg-white rounded px-6 rounded-lg shadow-sm  pt-4 pb-4  " >
                                    ...
                                    <p for="stability3" class="block mb-2 mt-2 text-sm font-medium yellow dark:text-gray-400">PROPOSITION</p>
