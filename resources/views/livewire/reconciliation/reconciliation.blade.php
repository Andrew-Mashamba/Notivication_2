...
{{--                            {{ App\Models\AccountsModel::count() }}--}}
                        ...
                        <li class="flex items-center">
                            ...
                            Non Matching Transactions:  <span>
...
{{--                                    {{ App\Models\AccountsModel::count() }}--}} 0
                                </span>
                            </span>
                        </li>
                    </ul>
        ...
        @if($this->tab_id == 1 )
            <livewire:reconciliation.order.create-order/>
        @endif

        @if($this->tab_id == 2 )
            <livewire:reconciliation.pending-orders.pending-orders/>
        @endif

        @if($this->tab_id == 3 )
            <livewire:reconciliation.reports.show/>
        @endif
