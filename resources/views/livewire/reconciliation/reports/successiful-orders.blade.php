...
<div>
    ...
    <div class="">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <x-jet-section-title>
                <x-slot name="title">CRDB Reconciliation report</x-slot>
                ...
                <div class="">
                    <div class="overflow-hidden">
                        <table id="standings" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tr>
                                <th scope="col" class="text-sm font-medium yellow px-6 py-4 text-left">
                                ...
                                <th scope="col" class="text-sm font-medium yellow px-6 py-4 text-right">
                                    Closing balance {{number_format($this->running_balance)}}
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium yellow">

                                </td>
                                <td class="text-sm yellow font-light px-6 py-4 whitespace-nowrap">

                                </td>
                                <td class="text-sm yellow font-light px-6 py-4 whitespace-nowrap">
                                    LESS: Un presented Cheque
                                </td>
                                <td class="text-sm yellow font-light px-6 py-4 whitespace-nowrap text-right">
                            ...
                            <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100 bg-white border-b text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 font-extrabold">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium yellow bg-white border-b text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                                </td>
                                <td class="text-sm yellow font-light px-6 py-4 whitespace-nowrap  bg-white border-b text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 font-bold">
                                    Total - Debit {{$this->endDatex}}
                                </td>
                                <td class="text-sm yellow font-light px-6 py-4 whitespace-nowrap bg-white border-b text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                                </td>
                                <td class="text-sm yellow font-light px-6 py-4 whitespace-nowrap text-right bg-white border-b text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 font-bold">
