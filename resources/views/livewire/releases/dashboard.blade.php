                    ...
                    <form>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Releases</h3>
                                <p class="text-gray-600 text-4xl font-bold">
                                    {{DB::table('releases')->get()->count()}}
                                </p>
                            </div>

                            <!-- Total Value of Pledged Stock -->
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Approved Releases</h3>
                                <p class="text-gray-600">
                                    {{DB::table('releases')->where('Status','APPROVED')->get()->count()}}
                                </p>
                            </div>

                            <!-- Visual Representation of Stock Distribution (Placeholder) -->
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Rejected Releases</h3>
                                <p class="text-gray-600">
                                    {{DB::table('releases')->where('Status','REJECTED')->get()->count()}}
                                </p>
                            </div>
