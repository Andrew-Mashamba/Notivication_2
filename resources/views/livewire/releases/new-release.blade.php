        ...
        <div aria-label="card" class="p-6 rounded-3xl bg-white w-full h-full ">
            ...
            <div aria-label="content" class="mt-9 grid gap-2.5">
                ...
                <div class="relative group">
                    <button wire:click="toggleDropdowna" class="inline-flex justify-between w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300  rounded-3xl shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">
                                  <span class="mr-2">
                                      @if($user)
                                          {{$this->clientNamea}}
                                      @else
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-2 -mr-1" viewBox="0 0 20 20" fill="#DD0035" aria-hidden="true">
                            <path fill-rule="evenodd" d="M6.293 9.293a1 1 0 011.414 0L10 11.586l2.293-2.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                    </button>
                    <div  class="{{ $isOpena ? '' : 'hidden' }} w-full mt-2 rounded-3xl bg-white ring-1 ring-black ring-opacity-5 p-1 space-y-1">
                        <!-- Search input -->
                        <input wire:model.debounce.300ms="search2" class="block w-full px-4 py-2 text-gray-800 border rounded-3xl border-gray-300 focus:outline-none" type="text" placeholder="Search items" autocomplete="off">
                        <!-- Dropdown content goes here -->
                        @foreach ($clients2 as $client)
                            <a href="#"  wire:click.away="closeDropdowna({{$client->id}})" class="rounded-3xl block px-4 py-2 text-gray-700 hover:bg-gray-100 active:bg-blue-100 cursor-pointer">{{ $client->first_name }} {{ $client->last_name }}</a>
                        @endforeach
                    </div>
                </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                            ...
                                            <div class="bg-gray-100 p-4 rounded-3xl">
                                                ...
                                                <div class="w-full flex">
                                                    <button wire:click="requestRelease({{$application->id}})" class="rounded-3xl w-full h-16 bg-blue-600 text-white border border-gray-300">Request Collateral Release</button>
                                                </div>
