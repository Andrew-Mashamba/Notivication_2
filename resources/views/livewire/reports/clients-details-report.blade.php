            ...
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                    <div class="flex items-center flex-1 w-full space-x-4">
                        ...
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" wire:model="search" id="simple-search" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                            </div>
                        </form>
                    </div>
                    <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                        ...
                        <button  wire:click="export" type="button" class="flex items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium yellow bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            @foreach($commodities as $commodity)
                                <th scope="col" class="px-6 py-3">{{ $commodity->name }}</th>
                            @endforeach
                        </tr>
                        </thead>
                        <tbody>

                        @foreach(DB::table('farmers')->get() as $farmer)
