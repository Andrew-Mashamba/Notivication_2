    ...
    <div class="flex w-full gap-2 mb-2 mb-2">
        <div class="ml-2">
            ...
            <div class="relative ">
                ...
                <input datepicker="" datepicker-autohide="" wire:model="startDate" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Select date">
            </div>
        </div>
        <div class="">
            <label for="category" class="block mb-2 dark:text-gray-400 space-x-2 text-sm font-semibold spacing-sm text-slate-600">
            ...
            <div class="relative ">
                ...
                <input datepicker="" datepicker-autohide="" wire:model="endDate" type="text" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Select date">
            </div>
        </div>
        <div>
            ...
            <select wire:model.bounce="branch" name="nodes" id="nodes" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
...
{{--         not used--}}
        <div class="hidden">
            ...
            <select wire:model.bounce="processorNodes" name="processorNodes" id="processorNodes" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                <option selected="" value="All">All </option>
        ...
        <div class="hidden">
            ...
            <select wire:model.bounce="services" name="services" id="services" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                <option selected="" value="All">All</option>
        ...
        <div class="hidden">
            ...
            <select wire:model.bounce="channels" name="channels" id="channels" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                <option selected="" value="All">All</option>
