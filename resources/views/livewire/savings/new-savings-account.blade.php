        ...
        <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
            ...
            <div class="flex items-stretch">
                ...
                <div class="w-1/2 mr-2" >
                    ...
                    <label for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Select Client</label>
                    ...
                    @if($this->member)
                        <div class="flex justify-between">
                            <label for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Existing share accounts</label>
                            <div>
                    ...
                    <label for="product" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Product</label>
