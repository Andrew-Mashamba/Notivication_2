                ...
                <div class="w-full bg-white  p-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">SavingsAccount Name</p>
                            ...
                            <p for="parentSavingsAccount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Parent SavingsAccount</p>
                            <select wire:model.bounce="parentSavingsAccount" name="parentSavingsAccount" id="parentSavingsAccount" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="w-1/2 mr-2" >
                                    ...
                                    @if($this->client)
                                        <div class="flex justify-between">
                                            <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Existing savings accounts</p>
                                            <div>
                ...
                <div class="flex items-stretch">
                    ...
                    <div class="w-1/2 mr-2" >
                        ...
                        @if($this->member)
                                ...
                                <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Saving Accounts</p>
                                @foreach(App\Models\AccountsModel::where('member_number',$this->member)->where('product_number','12')->get() as $account)
                                    @php
                                        $this->account_number = $account->account_number;
                                    @endphp
