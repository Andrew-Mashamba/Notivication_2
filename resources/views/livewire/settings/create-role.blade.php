<div>
    ...
    <div class="col-span-6 sm:col-span-4">
        <div class="flex w-full gap-4">
            <div class="w-1/2">
                <label for="role_name" class="block mb-2 text-sm font-medium yellow dark:text-white">Enter Role Name xxx</label>
            ...
            <div class="w-1/2">
                ...
                <input wire:model="description" id="description" class="block p-2.5 w-full text-sm yellow bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Enter description..."></input>
                <div class="mt-4"></div>
