                ...
                <div class="mr-2" >
                    ...
                    <div class="tab-content" id="tabs-tabContent">
                        <div class="tab-pane fade show active" id="tabs-home" role="tabpanel" aria-labelledby="tabs-home-tab">
                            ...
                            <x-jet-label for="department_name" value="{{ __('Enter Role name') }}" />
                            <div class="mt-2"></div>
                            <x-jet-input id="department_name" type="department_name" name="department_name" class="mt-1 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="mt-1">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" value="{{ $department->id }}" wire:model="departments"
                                                   class="form-checkbox h-6 w-6 text-blue-500 bg-gray-100
                                        rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
