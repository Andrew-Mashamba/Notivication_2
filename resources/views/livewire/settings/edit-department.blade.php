    ...
    <div class="col-span-6 sm:col-span-4">
            ...
            <div class="w-full flex gap-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <label for="role_name" class="block mb-2 text-sm font-medium yellow dark:text-white">Enter Role Name</label>
                        <input wire:model="role_name" type="text" id="role_name" class="bg-gray-50 border border-gray-300 yellow
                    ...
                    <div class="w-1/2">
                        <label for="description" class="block mb-2 text-sm font-medium yellow dark:text-white">Role description</label>
                        <textarea wire:model="description" id="description" rows="4" class="block p-2.5 w-full text-sm yellow bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter description..."></textarea>
                        <div class="mt-4"></div>
        ...
        @if($this->selectedrole)
            ...
            <label class="block mb-2 text-sm font-medium yellow dark:text-white">Select Permissions</label>
