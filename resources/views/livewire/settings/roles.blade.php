            ...
            <div class="flex w-full gap-2">
                ...
                <div class="bg-white w-1/3 rounded-2xl shadow-md shadow-gray-200 p-4">
                    ...
                    <div class="form-group col-span-6 sm:col-span-4 mb-4">
                        ...
                        <select id="role" wire:model="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm sm:px-3 sm:text-sm h-10" required>
