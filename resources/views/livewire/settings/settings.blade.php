<div>
    <div class="p-2">
        ...
        <div class="relative p-4 mb-2 overflow-hidden rounded-lg bg-white" >
            ...
            <div class="relative w-full">
                <div class="min-w-full text-center text-sm font-light">
                    <div class="text-xl text-blue-800 font-bold mb-1 ">
                ...
                <div>
                    ...
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-blue-400 dark:text-blue-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#DD0035" viewBox="0 0 20 20">
                        ...
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-blue-400 dark:text-gray-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#DD0035" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                            </svg>
                            Inactive Users:  <span>
                                <span class="ml-2 bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400"> {{App\Models\User::where('status','!=',"ACTIVE")->count()}} </span>
                            </span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="bg-white p-4 sm:p-6 overflow-hidden mb-2 rounded-lg">
            ...
            @if ($this->tab_id == $menuItem['id']) bg-blue-600 @else bg-gray-100 @endif
                            @if ($this->tab_id == $menuItem['id']) text-white font-bold @else text-gray-400 font-semibold @endif
                                    py-2 px-4 rounded-lg"

                            onmouseover="this.style.backgroundColor='#bfdbfe'; this.style.color='#333333';"
                            onmouseout="this.style.backgroundColor=''; this.style.color='';"
                    >

                        <div wire:loading wire:target="setView({{ $menuItem['id'] }})">
                            <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:yellow fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="tab-pane fade " id="tabs-homeJustify"
                ...
                <livewire:settings.password-policy/>
                           @break
                        @case('6')
                    @if(in_array(6, session()->get('permissions')))
                            <button wire:click="createNewUser" wire:loading.attr="disabled" class="bg-blue-600 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded my-3">New User</button>
                    @endif
                        ...
                        <div class="w-full">
                            ...
                            <div >
                                ...
                                <div class="form-group col-span-6 sm:col-span-4 mb-4">
                                    ...
                                    <select id="role" wire:model="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm sm:px-3 sm:text-sm h-10" requigreen>
                    ...
                    <div class="bg-white p-4">
                        ...
                        @if($this->pendinguser)
                                ...
                                <div class="form-group col-span-6 sm:col-span-4 mb-4">
                                    ...
                                    <select id="role" wire:model="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm sm:px-3 sm:text-sm h-10" requigreen>
                                        <option value="" selected>{{$this->role}}</option>
