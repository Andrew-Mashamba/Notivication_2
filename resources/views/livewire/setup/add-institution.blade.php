    ...
    <div class="bg-gray-100 rounded rounded-lg shadow-sm ">
        ...
        <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
            ...
            <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Institution Number</p>
                <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">{{$this->currentInstitutionID}}</p>

                <div class="mt-2"></div>

                <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Institution Name</p>
                <input type="text" id="name" name="name"  class="bg-gray-50 border border-gray-300 yellow text-sm
                ...
                <input type="text" id="region" name="region"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <input type="text" id="wilaya" name="wilaya"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <p for="phone_number" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">phone_number</p>
                <input type="number" id="phone_number" name="phone_number"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <p for="aname" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Admin name</p>
                <input type="aname" id="aname" name="aname"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <p for="email" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Admin  email</p>
                <input type="email" id="email" name="email"  class="bg-gray-50 border border-gray-300 yellow text-sm
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        @foreach(App\Models\loan_images::where('loan_id',App\Models\LoansModel::where('id',Session::get('currentloanID'))->value('loan_id'))->where('category','business')->get() as $image)
                            ...
                            <div  class="bg-white rounded h-full text-grey-darkest no-underline shadow-md w-64">
                                <div class="w-full justify-items-right">
                                    <svg wire:click="close" xmlns="http://www.w3.org/2000/svg" class=" object-right h-12 w-12 bg-slate-50 rounded-full stroke-red-400 p-2" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
