                ...
                <div class="w-full bg-white  p-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <p for="name" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">SharesAccount Name</p>
                            ...
                            <p for="parentSharesAccount" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Parent SharesAccount</p>
                            <select wire:model.bounce="parentSharesAccount" name="parentSharesAccount" id="parentSharesAccount" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="w-1/2 mr-2" >
                                    ...
                                    @if($this->member)
                                        <div class="flex justify-between">
                                            <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Existing shares accounts</p>
                                            <div>
                ...
                <div class="flex items-stretch">
                    ...
                    <div class="w-1/2 mr-2" >
                        ...
                        @if($this->member)
                            ...
                            <p for="member" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Share Account</p>
                        ...
                        @if($this->product)
                            ...
                            <div class="flex justify-between">
                                ...
                                <p class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Available shares for this user</p>
                                @php
                                            $minimum_shares = 200;
                        ...
                        <p for="linked_savings_account" class="block mb-2 text-sm font-medium yellow dark:text-gray-400">Purchase from linked Savings Account</p>
                        <select wire:model.bounce="linked_savings_account" name="linked_savings_account" id="linked_savings_account" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected value="">Select</option>
