    ...
    <div class="gradient-6">
        ...
        <div
            ...
            <div class="flex justify-between items-center pr-3 sm:px-2 items-center pr-3 sm:px-2 ">
                ...
                <!-- Logo-->
                <a class="block w-full  flex items-center mb-4" href="{{ route('System') }}">
                    <img class="m-auto" src="{{ asset('/absa.png') }}"
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        <!-- Dashboard -->
                        <li id="reloadAll" class="px-3 py-2  onhover   rounded-3xl mb-2 @if($this->tab_id == 0) app-bg-color text-white  hover:text-white @else  @endif cursor-pointer "  onmouseover="this.style.backgroundColor='#DD0035'; this.style.color='#ffffff';" onmouseout="this.style.backgroundColor=''; this.style.color='';">
                                <div wire:click="menuItemClicked(0)" wire:loading.attr="disabled"  class="flex items-center justify-between block text-slate-200 hover:text-white truncate transition duration-150">
                                    <div class="flex items-center">
                                        ...
                                        <svg class="shrink-0 w-6 h-6 " viewBox="0 0 24 24">
                                            ...
                                            <path class="fill-current @if($this->tab_id == 0){{ 'text-red-800' }}@else{{ 'text-red-800' }}@endif" d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z" />
                                        ...
                                        <span class="text-sm hover:text-white  @if($this->tab_id == 0) text-white font-bold  @else  text-red-800 font-semibold   @endif  ml-3 ">Dashboard</span>
                                    </div>
                                    <!-- Icon -->
                        ...
                        @foreach($this->menuItems as $item)
                            @if($item == 0 || $item == 5 || $item == 10 || $item == 11 || $item == 14 || $item == 16  )
                                @continue
                            @endif

                            <li  class="px-3 py-2 rounded-3xl mb-2 last:mb-0 @if($this->tab_id == $item) app-bg-color text-white  hover:text-white @else  @endif cursor-pointer " onmouseover="this.style.backgroundColor='#bfdbfe'; this.style.color='#ffffff';" onmouseout="this.style.backgroundColor=''; this.style.color='';" >
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        @if($item == "1" )
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="#DD0035" stroke-width="2">
                                                    <path class="@if($this->tab_id == $item) {{ 'text-white-500' }}@else{{ 'text-red-800 hover:text-white' }}@endif" stroke-linecap="round" stroke-linejoin="round" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" />
                                                </svg>
                                        ...
                                        @if($item == "8" )
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#DD0035" class="w-6 h-6 mr-2 ">
                                                    <path class="@if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-800' }}@endif" stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                                                </svg>
                                            ...
                                            @endif
                                             ...
                                             @if($item == "9" )
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#DD0035" class="w-6 h-6 mr-2">
                                                    <path class="@if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-800' }}@endif" stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                                                </svg>
                                            ...
                                            @endif
                                             ...
                                             @if($item == "12" )
                                                ...
                                                <svg data-slot="icon" class="w-6 h-6 mr-2 "  fill="none" stroke-width="1.5" stroke="#DD0035" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    <path stroke-linecap="round" class="@if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-800' }}@endif" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"></path>
                                                </svg>
                                            ...
                                            @if($item == "14")
                                                <svg class="w-6 h-6 mr-2 " data-slot="icon" fill="none" stroke-width="1.5" stroke="#DD0035" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    <path class="@if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-800' }}@endif" stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z"></path>
                                                </svg>
                                            @endif
                                        ...
                                        <span class="text-sm   @if($this->tab_id == $item) text-white font-bold  @else  text-red-800 font-semibold  @endif ml-3  "  >{{ \App\Models\menus::where('id', $item)->first()->menu_name  }}</span>
                                    </div>
                                    <!-- Icon -->
                                    <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
