    ...
    <div class=" flex justify-end item-end ">
        ...
        <div class="flex w-1/4 justify-end item-end mb-2">
            ...
            <input type="date" id="states" wire:model="date" wire:change="refreshComponent"
                    class="bg-gray-50 border border-gray-300 yellow text-sm rounded-r-lg
                            ...
                            <div class="w-full p-4 ">
                                ...
                                @if($this->status=="OVER")
                                    <div class="mt-4 w-full">
                                        ...
                                        <div class="flex gap-4 items-center text-center">
                                            <select  wire:model="account_number_destination" name="setSubMenuPermission" class="mt-1 block w-full bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" required>
                                ...
                                @elseif($this->status=="UNDER")
                                    <div class="mt-4 w-full">
                                        ...
                                        <div class="flex gap-4 items-center text-center">
                                            <input  wire:model="account_number" type="text" name="setSubMenuPermission" class="mt-1 block w-full bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" required />
                                        </div>
                                    </div>
                                ...
                                <input wire:model.defer="password" id="current_password" type="password" class="mt-1 block w-full bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" autocomplete="current-password" />
