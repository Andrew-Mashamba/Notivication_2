                ...
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        <div class="p-4">
                            ...
                            <select wire:model="branch_id" name="branch_id" id="branch_id" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <input id="max_amount" name="max_amount" type="text" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model="max_amount" autofocus >
                            </input>
                            @error('max_amount')
                ...
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        <div class="p-4">
                            ...
                            <input id="password" name="password" type="password"  class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                ...
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        <div class="p-4">
                            ...
                            <select wire:model="employee_details" name="employee_details" id="employee_details" class="mt-2 bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        <div class="max-w-md mx-auto bg-white p-4 rounded-lg shadow">
                                            <table class="w-full">
                                                ...
                                                <tr class="border-t-2">
                                                    ...
                                                    <td class="py-2">{{DB::table('roles')->where('id',DB::table('employees')->where('id',$this->employee_details)->value('role'))->value('department_name')}}</td>
                                                </tr>
