            ...
            <div class="flex justify-between w-full ">
                ...
                <div>
                    <div >
                        ...
                        <select wire:model="tilId" class="mb-2 w-full text-sm yellow border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                ...
                <div>
                    <input wire:model="selectedDate" type="date" class="mb-2 w-full text-sm yellow border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                </div>
            ...
            <div class="w-2/3 bg-white rounded-2xl p-4 relative">
                ...
                <div class="w-full mb-1 flex gap-1 bg-gray-200 p-1 rounded-2xl ">
                    <div class="w-1/2 bg-white rounded-2xl p-4">
                        <label for="input-group-1" class="block mb-2 text-sm font-medium yellow dark:text-white">
                            Enter Cash At Hand
                        </label>
                        <div class="relative mb-2">
                            ...
                            <input wire:model.difer="tellerEndOfDay.tiller_cash_at_hand" type="number" id="input-group-1" class="bg-gray-50 border border-gray-300 yellow text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="">
                        </div>
