                    ...
                    <form>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Total System Roles</h3>
                                <p class="text-gray-600 text-4xl font-bold">
                                    {{DB::table('roles')->get()->count()}}
                                </p>
                            </div>

                            <!-- Total Value of Pledged Stock -->
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Pending Roles</h3>
                                <p class="text-gray-600 font-bold">
                                    {{DB::table('roles')->where('status','PENDING')->get()->count()}}
                                </p>
                            </div>

                            <!-- Visual Representation of Stock Distribution (Placeholder) -->
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Active Roles</h3>
                                <p class="text-gray-600 font-bold">
                                    {{DB::table('roles')->where('status','ACTIVE')->get()->count()}}
                                </p>
                            </div>

                            <!-- Visual Representation of Stock Distribution (Placeholder) -->
                            <div class="bg-red-100 p-4 rounded-3xl">
                                <h3 class="text-lg font-semibold mb-2">Blocked Roles</h3>
                                <p class="text-gray-600 font-bold">
                                    {{DB::table('roles')->where('status','BLOCKED')->get()->count()}}
                                </p>
                            </div>
                        ...
                        <div class="bg-gray-100 p-4 rounded-3xl w-full mt-4">
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <livewire:datatable
                                        ...
                                        name="departments"
                                        include="department_name, description, status"
                                        dates="dob"
