<div>
    ...
    <div class="w-full">
        <div class="text-xs leading-none text-gray-400 font-normal first:pl-0 uppercase mb-2">Process Name</div>
        <div class="text-xs leading-none text-gray-600 font-semibold first:pl-0">
            {{\Illuminate\Support\Facades\DB::table('processes')->where('id',Session::get('ItemOnView'))->value('process_name')}}
        </div>
    </div>

    <div class="w-full mt-4">
    <div class="inline-block text-xs leading-none text-gray-400 font-normal first:pl-0 uppercase">Process Steps</div>

    <div class="w-full p-1 mt-2 bg-gray-200 rounded-3xl flex flex-wrap gap-1" id="steps-container">

        @foreach(\Illuminate\Support\Facades\DB::table('steps')->where('process_id',Session::get('ItemOnView'))->orderBy('step_number')->get() as $step)
