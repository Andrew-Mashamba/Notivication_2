<div>
    ...
    <div class=" py-3 rounded text-center">
        ...
        <div id="otp" class="flex flex-row justify-center text-center px-2 mt-5">
            <input  class="m-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50  h-10 w-10 text-center form-control rounded" type="text" id="otp1" maxlength="1" />
            <input  class="m-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 h-10 w-10 text-center form-control rounded" type="text" id="otp2" maxlength="1" />
            <input  class="m-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 h-10 w-10 text-center form-control rounded" type="text" id="otp3" maxlength="1" />
            <input class="m-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 h-10 w-10 text-center form-control rounded" type="text" id="otp4" maxlength="1" />
            <input  class="m-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 h-10 w-10 text-center form-control rounded" type="text" id="otp5" maxlength="1" />
            <input  class="m-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 h-10 w-10 text-center form-control rounded" type="text" id="otp6" maxlength="1" />
        </div>
        ...
        <div class="flex justify-center text-center mt-5 mb-5">
            ...
            <div wire:loading.remove wire:target="logout" >
                <button wire:click="logout" type="button" class="p-2 text-sm font-medium yellow focus:outline-none
