                    ...
                    <div class="justify-start   flex item-start">
                     <ul>
                         ...
                         <li class="flex items-center">
                             <svg fill="red" class="w-3.5 h-3.5 mr-2 text-black-400 dark:text-blue-400 flex-shrink-0" stroke="black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#DD0035" viewBox="0 0 20 20">
