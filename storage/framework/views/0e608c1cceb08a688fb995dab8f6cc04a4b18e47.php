  ...
  <div class="w-full flex gap-2">
    ...
    <script>
        window.onload = function() {
            const clearAfter = "<?php echo e(session('ClearSuccessAfter')); ?>";
            if (clearAfter) {
                setTimeout(function() {
                    <?php if(session()->has('RegisterStockSuccess')): ?>
                    <?php session()->forget('RegisterStockSuccess') ?>
                    <?php endif; ?>
...
<?php /**PATH /var/www/html/Notivication_2/resources/views/livewire/dashboard/quick-actions.blade.php ENDPATH**/ ?>