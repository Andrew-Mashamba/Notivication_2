...
} elseif ($_instance->childHasBeenRendered('l4121100863-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4121100863-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4121100863-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4121100863-0');
} else {
    $response = \Livewire\Livewire::mount('subscribers.new-subscriber', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4121100863-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l4121100863-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4121100863-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4121100863-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4121100863-1');
} else {
    $response = \Livewire\Livewire::mount('subscribers.dashboard', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4121100863-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('l4121100863-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4121100863-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4121100863-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4121100863-2');
} else {
    $response = \Livewire\Livewire::mount('subscribers.view-subscriber', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4121100863-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
<?php /**PATH C:\Apache24\htdocs\notification\resources\views/livewire/subscribers/subscribers.blade.php ENDPATH**/ ?>