                    ...
                    <div class="flex rounded-lg w-96 shadow-sm">
                        <div class="relative flex-grow focus-within:z-10">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-400" viewBox="0 0 20 20" stroke="#DD0035" fill="none">
...
<?php endif; ?>
                ...
                <?php if(count($this->massActionsOptions)): ?>
                    <div class="flex items-center justify-center space-x-1">
                        ...
                        <select wire:model="massActionOption" class="px-3 text-xs font-medium tracking-wider uppercase bg-white border border-blue-400 space-x-2 rounded-md leading-4 focus:outline-none" id="datatables_mass_actions">
                        ...
                        <button
                            ...
                            class="flex items-center px-4 py-2 text-xs font-medium tracking-wider text-blue-500 uppercase bg-white border border-blue-400 rounded-md leading-4 hover:bg-blue-200 focus:outline-none" type="submit" title="Submit"
                        >Go</button>
                    </div>
                <?php endif; ?>
                ...
                <?php if($exportable): ?>
                    <div x-data="{ init() {
                        ...
                        <button wire:click="export" class="flex items-center px-3 text-xs font-medium tracking-wider text-blue-500 uppercase bg-white border border-blue-400 space-x-2 rounded-md leading-4 hover:bg-blue-200 focus:outline-none"><span><?php echo e(__('Export')); ?></span>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?></button>
                ...
                <?php $__currentLoopData = $columnGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button wire:click="toggleGroup('<?php echo e($name); ?>')"
                            class="px-3 py-2 text-xs font-medium tracking-wider text-blue-500 uppercase bg-white border border-blue-400 rounded-md leading-4 hover:bg-blue-200 focus:outline-none">
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l2142781938-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2142781938-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2142781938-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2142781938-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l2142781938-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
    ...
    <span class="hidden text-sm text-left text-center text-right yellow bg-gray-100 bg-yellow-100 leading-5 bg-gray-50"></span>
</div>
<?php /**PATH C:\Apache24\htdocs\notification\vendor\mediconesystems\livewire-datatables\src/../resources/views/livewire/datatables/datatable.blade.php ENDPATH**/ ?>