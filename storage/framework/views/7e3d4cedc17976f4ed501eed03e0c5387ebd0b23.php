                ...
                <span class="flex items-center justify-center w-14 h-14 shrink-0 rounded-full bg-white yellow">
                    <img src="<?php echo e(asset('images/avatar.png')); ?>" class="rounded-full h-12" alt="Avatar Image">
                                    ...
                                    <div class="flex flex-col flex-1">
                                        ...
                                        <h3 class="text-sm font-medium"><?php echo e($client->subscriber_name); ?> </h3>
                                        ...
                                        <span class="inline-block px-3 text-xs leading-none text-gray-400 font-normal first:pl-0">
                                            ...
                                            <span class="inline-block px-3 text-xs leading-none text-gray-400 font-normal first:pl-0">
                                            <?php echo e($client->subscriber_phone_number); ?>
                    ...
                    <div aria-label="content" class="mt-9 grid gap-2.5">
                        ...
                        <div wire:loading.remove wire:target="loadView">
                            <?php if($this->viewLoaded == "a"): ?>
                                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('subscribers.new-subscriber', [])->html();
} elseif ($_instance->childHasBeenRendered('l4274874075-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4274874075-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4274874075-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4274874075-0');
} else {
    $response = \Livewire\Livewire::mount('subscribers.new-subscriber', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4274874075-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php elseif($this->viewLoaded == "b"): ?>
                                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('subscribers.dashboard', [])->html();
} elseif ($_instance->childHasBeenRendered('l4274874075-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4274874075-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4274874075-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4274874075-1');
} else {
    $response = \Livewire\Livewire::mount('subscribers.dashboard', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4274874075-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
                                ...
                                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('subscribers.view-subscriber', [])->html();
} elseif ($_instance->childHasBeenRendered('l4274874075-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4274874075-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4274874075-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4274874075-2');
} else {
    $response = \Livewire\Livewire::mount('subscribers.view-subscriber', []);
    $html = $response->html();
    $_instance->logRenderedChild('l4274874075-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
<?php /**PATH /var/www/html/Notivication_2/resources/views/livewire/subscribers/subscribers.blade.php ENDPATH**/ ?>