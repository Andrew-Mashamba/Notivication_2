...
} elseif ($_instance->childHasBeenRendered('CQpHXMI')) {
    $componentId = $_instance->getRenderedChildComponentId('CQpHXMI');
    $componentTag = $_instance->getRenderedChildComponentTagName('CQpHXMI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CQpHXMI');
} else {
    $response = \Livewire\Livewire::mount('profile.update-password-form');
    $html = $response->html();
    $_instance->logRenderedChild('CQpHXMI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('ptrFwug')) {
    $componentId = $_instance->getRenderedChildComponentId('ptrFwug');
    $componentTag = $_instance->getRenderedChildComponentTagName('ptrFwug');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ptrFwug');
} else {
    $response = \Livewire\Livewire::mount('sidebar.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('ptrFwug', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <!-- Content area -->
...
} elseif ($_instance->childHasBeenRendered('hLeqQAH')) {
    $componentId = $_instance->getRenderedChildComponentId('hLeqQAH');
    $componentTag = $_instance->getRenderedChildComponentTagName('hLeqQAH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hLeqQAH');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('hLeqQAH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/html/Notivication_2/resources/views/layouts/app.blade.php ENDPATH**/ ?>