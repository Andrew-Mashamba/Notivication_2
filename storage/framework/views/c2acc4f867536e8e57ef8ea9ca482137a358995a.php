                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                ...
                                <p class="text-gray-600 text-xl font-bold">
                                    Number : <?php echo e(DB::table('subscribers')->get()->count()); ?>
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                ...
                                <p class="text-gray-600 text-sm">
                                    Number : <?php echo e(DB::table('subscribers')->where('Status','ACTIVE')->get()->count()); ?>
                            ...
                            <div class="bg-gray-100 p-4 rounded-3xl">
                                ...
                                <p class="text-gray-600 text-sm">
                                    Number : <?php echo e(DB::table('subscribers')->where('Status','INACTIVE')->get()->count()); ?>
...
<?php /**PATH /var/www/html/Notivication_2/resources/views/livewire/subscribers/dashboard.blade.php ENDPATH**/ ?>