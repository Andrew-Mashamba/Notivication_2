                ...
                <div class="w-1/3 ">
                    ...
                    <div class="flex items-center justify-center p-2">
                        <div wire:click="loadView('all')" aria-label="card" class="p-6 rounded-3xl cursor-pointer
                                <?php if($this->viewLoaded == 'all'): ?> bg-red-50 shadow-md <?php else: ?> bg-white shadow-sm <?php endif; ?>  w-full ">
                            ...
                            <div class="bg-red-600 text-white font-bold  px-4 py-2 rounded-3xl mb-2 mt-2 w-full">
                                <?php echo e(DB::table('notifications')->where('send_status','failed')->get()->count()); ?> Failed
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-1/3">
                    <div class="flex items-center justify-center p-2">
                        <div wire:click="loadView('sms')" aria-label="sms" class="p-6 rounded-3xl  cursor-pointer
                                <?php if($this->viewLoaded == 'sms'): ?> bg-red-50 shadow-md <?php else: ?> bg-white shadow-sm <?php endif; ?>  w-full ">
                ...
                <div class="w-1/3">
                    <div class="flex items-center justify-center p-2">
                        <div wire:click="loadView('mail')" aria-label="card" class="p-6 rounded-3xl  cursor-pointer
                                <?php if($this->viewLoaded == 'mail'): ?>  bg-red-50 shadow-md <?php else: ?> bg-white shadow-sm <?php endif; ?>  w-full ">
                            ...
                            <div class="bg-red-600  text-white font-bold  px-4 py-2 rounded-3xl mb-2 mt-2 w-full">
                                Failed : <?php echo e(DB::table('notifications')->where('send_status','failed')->count()); ?>
                ...
                <div class="bg-white p-4 sm:p-6 overflow-hidden mb-2 rounded-lg shadow-md shadow-gray-200">
                            <div wire:loading.remove wire:target="innerView">
                                ...
                                <?php if($this->viewLoaded == 'all'): ?>
                                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('notification.notification-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l178145444-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l178145444-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l178145444-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l178145444-0');
} else {
    $response = \Livewire\Livewire::mount('notification.notification-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l178145444-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('notification.notification-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l178145444-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l178145444-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l178145444-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l178145444-1');
} else {
    $response = \Livewire\Livewire::mount('notification.notification-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l178145444-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('notification.notification-table', [])->html();
} elseif ($_instance->childHasBeenRendered('l178145444-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l178145444-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l178145444-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l178145444-2');
} else {
    $response = \Livewire\Livewire::mount('notification.notification-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l178145444-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <?php if($this->viewLoaded == 'notification'): ?>
 <div class="w-full flex bg-gray-100 h-100 pl-2 pr-2 pt-1 pb-1 ">
  <div class="w-full">
      <div class="bg-white p-4 sm:p-6 overflow-hidden mb-2 rounded-lg shadow-md shadow-gray-200">
        <div wire:loading.remove wire:target="innerView">
            ...
            <div class=" flex w-full">
                ...
                <div class="flex mx-auto bg-gray-50 border-2 w-full  ">
                    ...
                    <select id="countries" wire:model="source_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <?php $__currentLoopData = $this->sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="relative">
                    ...
                    <div class="mt-2 flex flex-wrap">
                        <?php $__currentLoopData = $selected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selectedOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center bg-blue-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-700 mr-2 mb-2">
                                <span><?php echo e($options[$selectedOption]); ?></span>
                                <button type="button" wire:click="removeOption('<?php echo e($selectedOption); ?>')" class="ml-2 text-red-500">
                ...
                <div class="text-xs text-red-600"><?php echo e($error); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Apache24\htdocs\notification\resources\views/livewire/notification/notifications.blade.php ENDPATH**/ ?>