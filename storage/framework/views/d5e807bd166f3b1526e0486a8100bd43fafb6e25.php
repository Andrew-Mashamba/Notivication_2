...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'icons::chevron-up','data' => ['wire:loading.remove' => true,'class' => 'w-6 h-6 text-blue-600 stroke-current']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:loading.remove' => true,'class' => 'w-6 h-6 text-blue-600 stroke-current']); ?>
...
<?php endif; ?>
                        <?php else: ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'icons::chevron-down','data' => ['wire:loading.remove' => true,'class' => 'w-6 h-6 text-blue-600 stroke-current']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\Apache24\htdocs\notification\vendor\mediconesystems\livewire-datatables\src/../resources/views/livewire/datatables/header-no-hide.blade.php ENDPATH**/ ?>