                    ...
                    <div>
                      ...
                      <div class="text-center">
                                ...
                                <h3 class="text-lg font-semibold mb-6 mt-2">
                                    <?php echo e($this->source->source_name); ?>

                                </h3>

                                <div class="flex gap-2 w-full justify-center">

                                        <?php if($this->source->Status == 'ACTIVE'): ?>
                                        ...
                                        <?php else: ?>
                                            <?php if($this->source->Status == 'PENDING'): ?>
                                            <button
                                                type="button"
                                                wire:click="approve"
                                ...
                                <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-1/2 px-4">
                                        <div class="relative w-full mb-3">
                                            ...
                                            <h3 x-on:dblclick="$wire.doubleClick('<?php echo e($field); ?>')" class="cursor-pointer font-bold text-sm mt-3 mb-6 tracking-tight text-gray-900 leading-tight ease-linear transition-all duration-150">
                                                <?php echo e($this->source->$field); ?>
...
<?php /**PATH C:\Apache24\htdocs\notification\resources\views/livewire/clients/view-client.blade.php ENDPATH**/ ?>