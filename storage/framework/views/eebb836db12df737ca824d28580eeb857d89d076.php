    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="max-w-2xl m-auto mt-16">
            ...
            <div class="text-center px-4">
                ...
                <a href="<?php echo e(route('System')); ?>" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">Back To Dashboard</a>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/Notivication_2/resources/views/pages/utility/404.blade.php ENDPATH**/ ?>