...
class TableCommand extends DatabaseInspectionCommand
{
    ...
    protected function displayForCli(array $data)
    {
        ...
        $this->components->twoColumnDetail('<fg=blue;options=bold>'.$table['name'].'</>');
        ...
        if ($columns->isNotEmpty()) {
            $this->components->twoColumnDetail('<fg=blue;options=bold>Column</>', 'Type');
        ...
        if ($indexes->isNotEmpty()) {
            $this->components->twoColumnDetail('<fg=blue;options=bold>Index</>');
        ...
        if ($foreignKeys->isNotEmpty()) {
            $this->components->twoColumnDetail('<fg=blue;options=bold>Foreign Key</>', 'On Update / On Delete');
