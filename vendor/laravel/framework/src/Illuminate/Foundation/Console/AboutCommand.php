...
class AboutCommand extends Command
{
    ...
    protected function displayDetail($data)
    {
        $data->each(function ($data, $section) {
            ...
            $this->components->twoColumnDetail('  <fg=blue;options=bold>'.$section.'</>');
    ...
    protected function gatherApplicationInformation()
    {
        ...
        static::addToSection('Cache', fn () => [
            'Config' => $this->laravel->configurationIsCached() ? '<fg=blue;options=bold>CACHED</>' : '<fg=yellow;options=bold>NOT CACHED</>',
            'Events' => $this->laravel->eventsAreCached() ? '<fg=blue;options=bold>CACHED</>' : '<fg=yellow;options=bold>NOT CACHED</>',
            'Routes' => $this->laravel->routesAreCached() ? '<fg=blue;options=bold>CACHED</>' : '<fg=yellow;options=bold>NOT CACHED</>',
            'Views' => $this->hasPhpFiles($this->laravel->storagePath('framework/views')) ? '<fg=blue;options=bold>CACHED</>' : '<fg=yellow;options=bold>NOT CACHED</>',
        ]);
