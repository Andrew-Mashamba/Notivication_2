...
class DocsCommand extends Command
{
     ...
     * @var string
     */
    protected $help = 'If you would like to perform a content search against the documention, you may call: <fg=blue>php artisan docs -- </><fg=blue;options=bold;>search query here</>';
