...
class ShowModelCommand extends DatabaseInspectionCommand
{
    ...
    protected function displayCli($class, $database, $table, $policy, $attributes, $relations, $observers)
    {
        ...
        $this->components->twoColumnDetail('<fg=blue;options=bold>'.$class.'</>');
        ...
        $this->components->twoColumnDetail(
            '<fg=blue;options=bold>Attributes</>',
        ...
        $this->components->twoColumnDetail('<fg=blue;options=bold>Relations</>');
        ...
        $this->components->twoColumnDetail('<fg=blue;options=bold>Observers</>');
