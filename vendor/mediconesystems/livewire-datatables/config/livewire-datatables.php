...
return [
    ...
    */
    ...
    'default_classes' => [
        'row' => [
            'even' => 'divide-x divide-gray-100 text-sm yellow bg-gray-100',
            'odd' => 'divide-x divide-gray-100 text-sm yellow bg-gray-50',
            'selected' => 'divide-x divide-gray-100 text-sm yellow bg-yellow-100',
        ],
        'cell' => 'whitespace-no-wrap text-sm yellow px-6 py-2',
    ],
];
