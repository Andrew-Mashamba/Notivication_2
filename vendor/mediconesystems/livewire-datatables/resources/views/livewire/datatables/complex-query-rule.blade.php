    ...
    >
            ...
            <div class="sm:w-1/3">
                ...
                <div class="relative">
                    <select wire:model="rules.{{ $key }}.column" name="selectedColumn"
                        class="w-full my-1 text-sm yellow leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        <option value=""></option>
                        ...
                        <div class="relative">
                            ...
                            @elseif($column['type'] === 'date')
                                <input type="date" name="value" wire:model.lazy="rules.{{ $key }}.value"
                                    class="w-full px-3 py-2 border my-1 text-sm yellow leading-4 block rounded-md border-gray-300 shadow-sm focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
        ...
        <div class="flex justify-center sm:justify-end">
            <button wire:click="duplicateRule('{{ $key }}')"
                class="mb-px w-9 h-9 flex items-center justify-center rounded text-blue-600 hover:text-blue-400">
                <x-icons.copy />
            </button>
