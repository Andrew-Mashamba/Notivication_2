            ...
            <div class="flex flex-wrap items-center space-x-1">
                ...
                @if($exportable)
                    <div x-data="{ init() {
                        ...
                        <button wire:click="export" class="flex items-center px-3 text-xs font-medium tracking-wider text-blue-500 uppercase bg-white border border-blue-400 space-x-2 rounded-md leading-4 hover:bg-blue-200 focus:outline-none"><span>{{ __('Export') }}</span>
