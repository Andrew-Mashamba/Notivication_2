...
class LivewireDatatable extends Component
{
    ...
    public function rowClasses($row, $loop)
    {
        ...
        if ($this->rowIsSelected($row)) {
            return config('livewire-datatables.default_classes.row.selected', 'divide-x divide-gray-100 text-sm yellow bg-yellow-100');
        } else {
            if ($loop->even) {
                return config('livewire-datatables.default_classes.row.even', 'divide-x divide-gray-100 text-sm yellow bg-gray-100');
            } else {
                return config('livewire-datatables.default_classes.row.odd', 'divide-x divide-gray-100 text-sm yellow bg-gray-50');
            }
        }
    }
    ...
    public function cellClasses($row, $column)
    {
        ...
        return config('livewire-datatables.default_classes.cell', 'text-sm yellow');
    }
