    ...
    <div>
        @if ($component->filtersAreEnabled() && $component->filterPillsAreEnabled() && $component->hasAppliedVisibleFiltersForPills())
            <div class="mb-4 px-4 md:p-0">
                    ...
                    @else
                        ...
                        >
                            ...
                            >
                                ...
                                <svg class="h-2 w-2" stroke="#DD0035" fill="none" viewBox="0 0 8 8">
                ...
                >
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-200 dark:yellow">
                        @lang('Clear')
                    </span>
                </button>
            </div>
            ...
            <div class="mb-3">
                ...
                @foreach($component->getAppliedFiltersWithValues() as $filterSelectName => $value)
                    ...
                    >
                        ...
                        >
                            <span class="sr-only">@lang('Remove filter option')</span>
                            <svg style="width:.5em;height:.5em" stroke="#DD0035" fill="none" viewBox="0 0 8 8">
                                <path stroke-linecap="round" stroke-width="1.5" d="M1 1l6 6m0-6L1 7" />
                            </svg>
                        </a>
                    </span>
